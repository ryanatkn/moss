import{f as w,a as l,s as n,c as t,t as e,A as M,r as o}from"../chunks/disclose-version.C18h83_w.js";import{p as V,a as K,t as j,J as A}from"../chunks/runtime.C2zfFJJN.js";import{s as U}from"../chunks/render.DoF8UeDv.js";import{e as I,i as L}from"../chunks/class.pTPFZAyC.js";import{C as b}from"../chunks/Code.DTj2vom3.js";import{T as Q}from"../chunks/Tome_Detail.Nxxv2o17.js";import{T as Z}from"../chunks/Tome_Link.CAWAg93d.js";import{G as P}from"../chunks/Github_Logo.DUAOTyqZ.js";import{a as nn}from"../chunks/tome.CUyVYEB6.js";import{D as R}from"../chunks/Details.DZVYVCv7.js";import{T as g}from"../chunks/Tome_Subheading.BmwEYSTJ.js";import{U as an}from"../chunks/Unfinished_Implementation_Warning.CK0zMplK.js";const on=`/* @ryanatkn/moss/style_utilities.css */
...
/* not including \`.flex_nowrap\` because it's the initial value and it's not inherited */
.flex_wrap {
	flex-wrap: wrap;
}
.flex_wrap_reverse {
...
.shadow_sm {
	box-shadow: var(--shadow_sm) var(--shadow_color_sm);
}
.shadow_md {
	box-shadow: var(--shadow_md) var(--shadow_color_md);
}
.shadow_lg {
	box-shadow: var(--shadow_lg) var(--shadow_color_lg);
}
.shadow_xl {
	box-shadow: var(--shadow_xl) var(--shadow_color_xl);
}
.shadow_outset_xs {
	box-shadow: var(--shadow_outset_xs) var(--shadow_color_xs);
}
.shadow_outset_sm {
	box-shadow: var(--shadow_outset_sm) var(--shadow_color_sm);
}
.shadow_outset_md {
	box-shadow: var(--shadow_outset_md) var(--shadow_color_md);
}
.shadow_outset_lg {
	box-shadow: var(--shadow_outset_lg) var(--shadow_color_lg);
}
.shadow_outset_xl {
	box-shadow: var(--shadow_outset_xl) var(--shadow_color_xl);
}
.shadow_inset_xs {
...
.shadow_inset_md {
	box-shadow: var(--shadow_inset_md) var(--shadow_color_md);
}
.shadow_inset_lg {
	box-shadow: var(--shadow_inset_lg) var(--shadow_color_lg);
}
.shadow_inset_xl {
	box-shadow: var(--shadow_inset_xl) var(--shadow_color_xl);
}

/* highlights */

.highlight_xs {
	box-shadow: var(--shadow_xs) var(--highlight_color_xs);
}
.highlight_sm {
	box-shadow: var(--shadow_sm) var(--highlight_color_sm);
}
.highlight_md {
	box-shadow: var(--shadow_md) var(--highlight_color_md);
}
.highlight_lg {
	box-shadow: var(--shadow_lg) var(--highlight_color_lg);
}
.highlight_xl {
	box-shadow: var(--shadow_xl) var(--highlight_color_xl);
}
.highlight_outset_xs {
	box-shadow: var(--shadow_outset_xs) var(--highlight_color_xs);
}
.highlight_outset_sm {
	box-shadow: var(--shadow_outset_sm) var(--highlight_color_sm);
}
.highlight_outset_md {
	box-shadow: var(--shadow_outset_md) var(--highlight_color_md);
}
.highlight_outset_lg {
	box-shadow: var(--shadow_outset_lg) var(--highlight_color_lg);
}
.highlight_outset_xl {
	box-shadow: var(--shadow_outset_xl) var(--highlight_color_xl);
}
.highlight_inset_xs {
	box-shadow: var(--shadow_inset_xs) var(--highlight_color_xs);
}
.highlight_inset_sm {
	box-shadow: var(--shadow_inset_sm) var(--highlight_color_sm);
}
.highlight_inset_md {
	box-shadow: var(--shadow_inset_md) var(--highlight_color_md);
}
.highlight_inset_lg {
	box-shadow: var(--shadow_inset_lg) var(--highlight_color_lg);
}
.highlight_inset_xl {
	box-shadow: var(--shadow_inset_xl) var(--highlight_color_xl);
}

/* glows */

.glow_xs {
	box-shadow: var(--shadow_xs) var(--glow_color_xs);
}
.glow_sm {
	box-shadow: var(--shadow_sm) var(--glow_color_sm);
}
.glow_md {
	box-shadow: var(--shadow_md) var(--glow_color_md);
}
.glow_lg {
	box-shadow: var(--shadow_lg) var(--glow_color_lg);
}
.glow_xl {
	box-shadow: var(--shadow_xl) var(--glow_color_xl);
}
.glow_outset_xs {
	box-shadow: var(--shadow_outset_xs) var(--glow_color_xs);
}
.glow_outset_sm {
	box-shadow: var(--shadow_outset_sm) var(--glow_color_sm);
}
.glow_outset_md {
	box-shadow: var(--shadow_outset_md) var(--glow_color_md);
}
.glow_outset_lg {
	box-shadow: var(--shadow_outset_lg) var(--glow_color_lg);
}
.glow_outset_xl {
	box-shadow: var(--shadow_outset_xl) var(--glow_color_xl);
}
.glow_inset_xs {
	box-shadow: var(--shadow_inset_xs) var(--glow_color_xs);
}
.glow_inset_sm {
	box-shadow: var(--shadow_inset_sm) var(--glow_color_sm);
}
.glow_inset_md {
	box-shadow: var(--shadow_inset_md) var(--glow_color_md);
}
.glow_inset_lg {
	box-shadow: var(--shadow_inset_lg) var(--glow_color_lg);
}
.glow_inset_xl {
	box-shadow: var(--shadow_inset_xl) var(--glow_color_xl);
}

/* shrouds */

.shroud_xs {
	box-shadow: var(--shadow_xs) var(--shroud_color_xs);
}
.shroud_sm {
	box-shadow: var(--shadow_sm) var(--shroud_color_sm);
}
.shroud_md {
	box-shadow: var(--shadow_md) var(--shroud_color_md);
}
.shroud_lg {
	box-shadow: var(--shadow_lg) var(--shroud_color_lg);
}
.shroud_xl {
	box-shadow: var(--shadow_xl) var(--shroud_color_xl);
}
.shroud_outset_xs {
	box-shadow: var(--shadow_outset_xs) var(--shroud_color_xs);
}
.shroud_outset_sm {
	box-shadow: var(--shadow_outset_sm) var(--shroud_color_sm);
}
.shroud_outset_md {
	box-shadow: var(--shadow_outset_md) var(--shroud_color_md);
}
.shroud_outset_lg {
	box-shadow: var(--shadow_outset_lg) var(--shroud_color_lg);
}
.shroud_outset_xl {
	box-shadow: var(--shadow_outset_xl) var(--shroud_color_xl);
}
.shroud_inset_xs {
	box-shadow: var(--shadow_inset_xs) var(--shroud_color_xs);
}
.shroud_inset_sm {
	box-shadow: var(--shadow_inset_sm) var(--shroud_color_sm);
}
.shroud_inset_md {
	box-shadow: var(--shadow_inset_md) var(--shroud_color_md);
}
.shroud_inset_lg {
	box-shadow: var(--shadow_inset_lg) var(--shroud_color_lg);
}
.shroud_inset_xl {
	box-shadow: var(--shadow_inset_xl) var(--shroud_color_xl);
}

/* colorful shadows */

.shadow_a_xs {
	box-shadow: var(--shadow_xs) var(--shadow_color_a_xs);
}
.shadow_a_sm {
	box-shadow: var(--shadow_sm) var(--shadow_color_a_sm);
}
.shadow_a_md {
	box-shadow: var(--shadow_md) var(--shadow_color_a_md);
}
.shadow_a_lg {
	box-shadow: var(--shadow_lg) var(--shadow_color_a_lg);
}
.shadow_a_xl {
	box-shadow: var(--shadow_xl) var(--shadow_color_a_xl);
}
.shadow_a_outset_xs {
	box-shadow: var(--shadow_outset_xs) var(--shadow_color_a_xs);
}
.shadow_a_outset_sm {
	box-shadow: var(--shadow_outset_sm) var(--shadow_color_a_sm);
}
.shadow_a_outset_md {
	box-shadow: var(--shadow_outset_md) var(--shadow_color_a_md);
}
.shadow_a_outset_lg {
	box-shadow: var(--shadow_outset_lg) var(--shadow_color_a_lg);
}
.shadow_a_outset_xl {
	box-shadow: var(--shadow_outset_xl) var(--shadow_color_a_xl);
}
.shadow_a_inset_xs {
	box-shadow: var(--shadow_inset_xs) var(--shadow_color_a_xs);
}
.shadow_a_inset_sm {
	box-shadow: var(--shadow_inset_sm) var(--shadow_color_a_sm);
}
.shadow_a_inset_md {
	box-shadow: var(--shadow_inset_md) var(--shadow_color_a_md);
}
.shadow_a_inset_lg {
	box-shadow: var(--shadow_inset_lg) var(--shadow_color_a_lg);
}
.shadow_a_inset_xl {
	box-shadow: var(--shadow_inset_xl) var(--shadow_color_a_xl);
}
.shadow_b_xs {
	box-shadow: var(--shadow_xs) var(--shadow_color_b_xs);
}
.shadow_b_sm {
	box-shadow: var(--shadow_sm) var(--shadow_color_b_sm);
}
.shadow_b_md {
	box-shadow: var(--shadow_md) var(--shadow_color_b_md);
}
.shadow_b_lg {
	box-shadow: var(--shadow_lg) var(--shadow_color_b_lg);
}
.shadow_b_xl {
	box-shadow: var(--shadow_xl) var(--shadow_color_b_xl);
}
.shadow_b_outset_xs {
	box-shadow: var(--shadow_outset_xs) var(--shadow_color_b_xs);
}
.shadow_b_outset_sm {
	box-shadow: var(--shadow_outset_sm) var(--shadow_color_b_sm);
}
.shadow_b_outset_md {
	box-shadow: var(--shadow_outset_md) var(--shadow_color_b_md);
}
.shadow_b_outset_lg {
	box-shadow: var(--shadow_outset_lg) var(--shadow_color_b_lg);
}
.shadow_b_outset_xl {
	box-shadow: var(--shadow_outset_xl) var(--shadow_color_b_xl);
}
.shadow_b_inset_xs {
	box-shadow: var(--shadow_inset_xs) var(--shadow_color_b_xs);
}
.shadow_b_inset_sm {
	box-shadow: var(--shadow_inset_sm) var(--shadow_color_b_sm);
}
.shadow_b_inset_md {
	box-shadow: var(--shadow_inset_md) var(--shadow_color_b_md);
}
.shadow_b_inset_lg {
	box-shadow: var(--shadow_inset_lg) var(--shadow_color_b_lg);
}
.shadow_b_inset_xl {
	box-shadow: var(--shadow_inset_xl) var(--shadow_color_b_xl);
}
.shadow_c_xs {
	box-shadow: var(--shadow_xs) var(--shadow_color_c_xs);
}
.shadow_c_sm {
	box-shadow: var(--shadow_sm) var(--shadow_color_c_sm);
}
.shadow_c_md {
	box-shadow: var(--shadow_md) var(--shadow_color_c_md);
}
.shadow_c_lg {
	box-shadow: var(--shadow_lg) var(--shadow_color_c_lg);
}
.shadow_c_xl {
	box-shadow: var(--shadow_xl) var(--shadow_color_c_xl);
}
.shadow_c_outset_xs {
	box-shadow: var(--shadow_outset_xs) var(--shadow_color_c_xs);
}
.shadow_c_outset_sm {
	box-shadow: var(--shadow_outset_sm) var(--shadow_color_c_sm);
}
.shadow_c_outset_md {
	box-shadow: var(--shadow_outset_md) var(--shadow_color_c_md);
}
.shadow_c_outset_lg {
	box-shadow: var(--shadow_outset_lg) var(--shadow_color_c_lg);
}
.shadow_c_outset_xl {
	box-shadow: var(--shadow_outset_xl) var(--shadow_color_c_xl);
}
.shadow_c_inset_xs {
	box-shadow: var(--shadow_inset_xs) var(--shadow_color_c_xs);
}
.shadow_c_inset_sm {
	box-shadow: var(--shadow_inset_sm) var(--shadow_color_c_sm);
}
.shadow_c_inset_md {
	box-shadow: var(--shadow_inset_md) var(--shadow_color_c_md);
}
.shadow_c_inset_lg {
	box-shadow: var(--shadow_inset_lg) var(--shadow_color_c_lg);
}
.shadow_c_inset_xl {
	box-shadow: var(--shadow_inset_xl) var(--shadow_color_c_xl);
}
.shadow_d_xs {
	box-shadow: var(--shadow_xs) var(--shadow_color_d_xs);
}
.shadow_d_sm {
	box-shadow: var(--shadow_sm) var(--shadow_color_d_sm);
}
.shadow_d_md {
	box-shadow: var(--shadow_md) var(--shadow_color_d_md);
}
.shadow_d_lg {
	box-shadow: var(--shadow_lg) var(--shadow_color_d_lg);
}
.shadow_d_xl {
	box-shadow: var(--shadow_xl) var(--shadow_color_d_xl);
}
.shadow_d_outset_xs {
	box-shadow: var(--shadow_outset_xs) var(--shadow_color_d_xs);
}
.shadow_d_outset_sm {
	box-shadow: var(--shadow_outset_sm) var(--shadow_color_d_sm);
}
.shadow_d_outset_md {
	box-shadow: var(--shadow_outset_md) var(--shadow_color_d_md);
}
.shadow_d_outset_lg {
	box-shadow: var(--shadow_outset_lg) var(--shadow_color_d_lg);
}
.shadow_d_outset_xl {
	box-shadow: var(--shadow_outset_xl) var(--shadow_color_d_xl);
}
.shadow_d_inset_xs {
	box-shadow: var(--shadow_inset_xs) var(--shadow_color_d_xs);
}
.shadow_d_inset_sm {
	box-shadow: var(--shadow_inset_sm) var(--shadow_color_d_sm);
}
.shadow_d_inset_md {
	box-shadow: var(--shadow_inset_md) var(--shadow_color_d_md);
}
.shadow_d_inset_lg {
	box-shadow: var(--shadow_inset_lg) var(--shadow_color_d_lg);
}
.shadow_d_inset_xl {
	box-shadow: var(--shadow_inset_xl) var(--shadow_color_d_xl);
}
.shadow_e_xs {
	box-shadow: var(--shadow_xs) var(--shadow_color_e_xs);
}
.shadow_e_sm {
	box-shadow: var(--shadow_sm) var(--shadow_color_e_sm);
}
.shadow_e_md {
	box-shadow: var(--shadow_md) var(--shadow_color_e_md);
}
.shadow_e_lg {
	box-shadow: var(--shadow_lg) var(--shadow_color_e_lg);
}
.shadow_e_xl {
	box-shadow: var(--shadow_xl) var(--shadow_color_e_xl);
}
.shadow_e_outset_xs {
	box-shadow: var(--shadow_outset_xs) var(--shadow_color_e_xs);
}
.shadow_e_outset_sm {
	box-shadow: var(--shadow_outset_sm) var(--shadow_color_e_sm);
}
.shadow_e_outset_md {
	box-shadow: var(--shadow_outset_md) var(--shadow_color_e_md);
}
.shadow_e_outset_lg {
	box-shadow: var(--shadow_outset_lg) var(--shadow_color_e_lg);
}
.shadow_e_outset_xl {
	box-shadow: var(--shadow_outset_xl) var(--shadow_color_e_xl);
}
.shadow_e_inset_xs {
	box-shadow: var(--shadow_inset_xs) var(--shadow_color_e_xs);
}
.shadow_e_inset_sm {
	box-shadow: var(--shadow_inset_sm) var(--shadow_color_e_sm);
}
.shadow_e_inset_md {
	box-shadow: var(--shadow_inset_md) var(--shadow_color_e_md);
}
.shadow_e_inset_lg {
	box-shadow: var(--shadow_inset_lg) var(--shadow_color_e_lg);
}
.shadow_e_inset_xl {
	box-shadow: var(--shadow_inset_xl) var(--shadow_color_e_xl);
}
.shadow_f_xs {
	box-shadow: var(--shadow_xs) var(--shadow_color_f_xs);
}
.shadow_f_sm {
	box-shadow: var(--shadow_sm) var(--shadow_color_f_sm);
}
.shadow_f_md {
	box-shadow: var(--shadow_md) var(--shadow_color_f_md);
}
.shadow_f_lg {
	box-shadow: var(--shadow_lg) var(--shadow_color_f_lg);
}
.shadow_f_xl {
	box-shadow: var(--shadow_xl) var(--shadow_color_f_xl);
}
.shadow_f_outset_xs {
	box-shadow: var(--shadow_outset_xs) var(--shadow_color_f_xs);
}
.shadow_f_outset_sm {
	box-shadow: var(--shadow_outset_sm) var(--shadow_color_f_sm);
}
.shadow_f_outset_md {
	box-shadow: var(--shadow_outset_md) var(--shadow_color_f_md);
}
.shadow_f_outset_lg {
	box-shadow: var(--shadow_outset_lg) var(--shadow_color_f_lg);
}
.shadow_f_outset_xl {
	box-shadow: var(--shadow_outset_xl) var(--shadow_color_f_xl);
}
.shadow_f_inset_xs {
	box-shadow: var(--shadow_inset_xs) var(--shadow_color_f_xs);
}
.shadow_f_inset_sm {
	box-shadow: var(--shadow_inset_sm) var(--shadow_color_f_sm);
}
.shadow_f_inset_md {
	box-shadow: var(--shadow_inset_md) var(--shadow_color_f_md);
}
.shadow_f_inset_lg {
	box-shadow: var(--shadow_inset_lg) var(--shadow_color_f_lg);
}
.shadow_f_inset_xl {
	box-shadow: var(--shadow_inset_xl) var(--shadow_color_f_xl);
}
.shadow_g_xs {
	box-shadow: var(--shadow_xs) var(--shadow_color_g_xs);
}
.shadow_g_sm {
	box-shadow: var(--shadow_sm) var(--shadow_color_g_sm);
}
.shadow_g_md {
	box-shadow: var(--shadow_md) var(--shadow_color_g_md);
}
.shadow_g_lg {
	box-shadow: var(--shadow_lg) var(--shadow_color_g_lg);
}
.shadow_g_xl {
	box-shadow: var(--shadow_xl) var(--shadow_color_g_xl);
}
.shadow_g_outset_xs {
	box-shadow: var(--shadow_outset_xs) var(--shadow_color_g_xs);
}
.shadow_g_outset_sm {
	box-shadow: var(--shadow_outset_sm) var(--shadow_color_g_sm);
}
.shadow_g_outset_md {
	box-shadow: var(--shadow_outset_md) var(--shadow_color_g_md);
}
.shadow_g_outset_lg {
	box-shadow: var(--shadow_outset_lg) var(--shadow_color_g_lg);
}
.shadow_g_outset_xl {
	box-shadow: var(--shadow_outset_xl) var(--shadow_color_g_xl);
}
.shadow_g_inset_xs {
	box-shadow: var(--shadow_inset_xs) var(--shadow_color_g_xs);
}
.shadow_g_inset_sm {
	box-shadow: var(--shadow_inset_sm) var(--shadow_color_g_sm);
}
.shadow_g_inset_md {
	box-shadow: var(--shadow_inset_md) var(--shadow_color_g_md);
}
.shadow_g_inset_lg {
	box-shadow: var(--shadow_inset_lg) var(--shadow_color_g_lg);
}
.shadow_g_inset_xl {
	box-shadow: var(--shadow_inset_xl) var(--shadow_color_g_xl);
}
.shadow_h_xs {
	box-shadow: var(--shadow_xs) var(--shadow_color_h_xs);
}
.shadow_h_sm {
	box-shadow: var(--shadow_sm) var(--shadow_color_h_sm);
}
.shadow_h_md {
	box-shadow: var(--shadow_md) var(--shadow_color_h_md);
}
.shadow_h_lg {
	box-shadow: var(--shadow_lg) var(--shadow_color_h_lg);
}
.shadow_h_xl {
	box-shadow: var(--shadow_xl) var(--shadow_color_h_xl);
}
.shadow_h_outset_xs {
	box-shadow: var(--shadow_outset_xs) var(--shadow_color_h_xs);
}
.shadow_h_outset_sm {
	box-shadow: var(--shadow_outset_sm) var(--shadow_color_h_sm);
}
.shadow_h_outset_md {
	box-shadow: var(--shadow_outset_md) var(--shadow_color_h_md);
}
.shadow_h_outset_lg {
	box-shadow: var(--shadow_outset_lg) var(--shadow_color_h_lg);
}
.shadow_h_outset_xl {
	box-shadow: var(--shadow_outset_xl) var(--shadow_color_h_xl);
}
.shadow_h_inset_xs {
	box-shadow: var(--shadow_inset_xs) var(--shadow_color_h_xs);
}
.shadow_h_inset_sm {
	box-shadow: var(--shadow_inset_sm) var(--shadow_color_h_sm);
}
.shadow_h_inset_md {
	box-shadow: var(--shadow_inset_md) var(--shadow_color_h_md);
}
.shadow_h_inset_lg {
	box-shadow: var(--shadow_inset_lg) var(--shadow_color_h_lg);
}
.shadow_h_inset_xl {
	box-shadow: var(--shadow_inset_xl) var(--shadow_color_h_xl);
}
.shadow_i_xs {
	box-shadow: var(--shadow_xs) var(--shadow_color_i_xs);
}
.shadow_i_sm {
	box-shadow: var(--shadow_sm) var(--shadow_color_i_sm);
}
.shadow_i_md {
	box-shadow: var(--shadow_md) var(--shadow_color_i_md);
}
.shadow_i_lg {
	box-shadow: var(--shadow_lg) var(--shadow_color_i_lg);
}
.shadow_i_xl {
	box-shadow: var(--shadow_xl) var(--shadow_color_i_xl);
}
.shadow_i_outset_xs {
	box-shadow: var(--shadow_outset_xs) var(--shadow_color_i_xs);
}
.shadow_i_outset_sm {
	box-shadow: var(--shadow_outset_sm) var(--shadow_color_i_sm);
}
.shadow_i_outset_md {
	box-shadow: var(--shadow_outset_md) var(--shadow_color_i_md);
}
.shadow_i_outset_lg {
	box-shadow: var(--shadow_outset_lg) var(--shadow_color_i_lg);
}
.shadow_i_outset_xl {
	box-shadow: var(--shadow_outset_xl) var(--shadow_color_i_xl);
}
.shadow_i_inset_xs {
	box-shadow: var(--shadow_inset_xs) var(--shadow_color_i_xs);
}
.shadow_i_inset_sm {
	box-shadow: var(--shadow_inset_sm) var(--shadow_color_i_sm);
}
.shadow_i_inset_md {
	box-shadow: var(--shadow_inset_md) var(--shadow_color_i_md);
}
.shadow_i_inset_lg {
	box-shadow: var(--shadow_inset_lg) var(--shadow_color_i_lg);
}
.shadow_i_inset_xl {
	box-shadow: var(--shadow_inset_xl) var(--shadow_color_i_xl);
}
...
`,_n=`/* @ryanatkn/moss/style_components.css */
...
.selectable {
	/* TODO these are duplicated from buttons, needs refactoring, maybe make them vars? selected variants too? */
...
.pane {
	...
	box-shadow: var(--pane_shadow, var(--shadow_md) var(--shadow_color_md));
	border-radius: var(--radius_xs);
}
...
<script>
	...
	// ...
<\/script>`});var p=n(n(y,!0)),G=n(t(p));Z(G,{name:"variables"}),M(),o(p);var J=n(n(p,!0));n(n(J,!0)),o(x);var v=n(n(x,!0)),z=t(v);g(z,{text:"Utility classes",slug:"utility-classes"});var O=n(n(z,!0));I(O,73,()=>Y,L,(d,_,s)=>{var a=tn(),r=t(a);o(a),j(()=>U(r,`.${A(_)??""}`)),l(d,a)}),o(O),o(v);var h=n(n(v,!0)),T=t(h);g(T,{text:"Component classes",slug:"semantic-classes"});var F=n(n(T,!0)),D=n(n(F,!0));I(D,73,()=>N,L,(d,_,s)=>{var a=sn(),r=t(a);o(a),j(()=>U(r,`.${A(_)??""}`)),l(d,a)}),o(D),o(h);var $=n(n(h,!0)),S=t($);g(S,{text:"Raw CSS",slug:"raw-css"});var C=n(n(S,!0));R(C,{summary:_=>{var s=ln();l(_,s)},children:(_,s)=>{var a=en(),r=w(a),c=t(r),i=t(c);P(i,{size:"var(--icon_size_xs)"}),n(n(i,!0)),o(c),o(r);var m=n(n(r,!0));b(m,{content:on,lang:"css"}),l(_,a)},$$slots:{default:!0}});var H=n(n(C,!0));R(H,{summary:_=>{var s=dn();l(_,s)},children:(_,s)=>{var a=cn(),r=w(a),c=t(r),i=t(c);P(i,{size:"var(--icon_size_xs)"}),n(n(i,!0)),o(c),o(r);var m=n(n(r,!0));b(m,{content:_n,lang:"css"}),l(_,a)},$$slots:{default:!0}}),o($),l(X,u)},$$slots:{default:!0}}),K()}export{Dn as component};
