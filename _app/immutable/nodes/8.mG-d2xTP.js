import{f as b,a as l,s as n,c as r,t as e,A as C,r as _}from"../chunks/disclose-version.gZ-2tz3Z.js";import{p as V,a as K,t as j,J as A}from"../chunks/runtime.4yfH9i_8.js";import{s as I}from"../chunks/render.nIEHh2HH.js";import{e as U,i as L}from"../chunks/attributes.CPiNokUc.js";import{C as w}from"../chunks/Code.Pz-7eqrk.js";import{T as Q}from"../chunks/Tome_Detail.B78poo8S.js";import{T as Z}from"../chunks/Tome_Link.BlUdTKEc.js";import{G as P}from"../chunks/Github_Logo.Ddmgj9-e.js";import{a as nn}from"../chunks/tome.DlDF76X-.js";import{D as R}from"../chunks/Details.CmazD-f3.js";import{T as g}from"../chunks/Tome_Subheading.xFx2cJm0.js";import{U as an}from"../chunks/Unfinished_Implementation_Warning.WKqJHAkV.js";const _n=`/* @ryanatkn/moss/style_utilities.css */
...
<script>
	...
	// ...
<\/script>`});var x=n(n(y,!0)),G=n(r(x));Z(G,{name:"variables"}),C(),_(x);var J=n(n(x,!0));n(n(J,!0)),_(p);var h=n(n(p,!0)),z=r(h);g(z,{text:"Utility classes",slug:"utility-classes"});var O=n(n(z,!0));U(O,73,()=>N,L,(d,o,s)=>{var a=rn(),t=r(a);_(a),j(()=>I(t,`.${A(o)??""}`)),l(d,a)}),_(O),_(h);var v=n(n(h,!0)),T=r(v);g(T,{text:"Component classes",slug:"semantic-classes"});var F=n(n(T,!0)),$=n(n(F,!0));U($,73,()=>W,L,(d,o,s)=>{var a=sn(),t=r(a);_(a),j(()=>I(t,`.${A(o)??""}`)),l(d,a)}),_($),_(v);var D=n(n(v,!0)),S=r(D);g(S,{text:"Raw CSS",slug:"raw-css"});var M=n(n(S,!0));R(M,{summary:o=>{var s=ln();l(o,s)},children:(o,s)=>{var a=en(),t=b(a),c=r(t),i=r(c);P(i,{size:"var(--icon_size_xs)"}),n(n(i,!0)),_(c),_(t);var m=n(n(t,!0));w(m,{content:_n,lang:"css"}),l(o,a)},$$slots:{default:!0}});var H=n(n(M,!0));R(H,{summary:o=>{var s=dn();l(o,s)},children:(o,s)=>{var a=cn(),t=b(a),c=r(t),i=r(c);P(i,{size:"var(--icon_size_xs)"}),n(n(i,!0)),_(c),_(t);var m=n(n(t,!0));w(m,{content:on,lang:"css"}),l(o,a)},$$slots:{default:!0}}),_(D),l(X,u)},$$slots:{default:!0}}),K()}export{$n as component};
