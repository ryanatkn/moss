import{a as l,t as e,f as m,c as r,s as n,A as F,r as t}from"../chunks/disclose-version.gZ-2tz3Z.js";import{p as H,a as V,t as C,J as j}from"../chunks/runtime.4yfH9i_8.js";import{s as A}from"../chunks/render.nIEHh2HH.js";import{e as I,i as U}from"../chunks/attributes.CPiNokUc.js";import{C as b}from"../chunks/Code.DPL7Rrw_.js";import{T as K}from"../chunks/Tome_Detail.BzJkR5Yb.js";import{T as Q}from"../chunks/Tome_Link.Dg_4EXG1.js";import{G as L}from"../chunks/Github_Logo.CHdkiU-n.js";import{a as Z}from"../chunks/tome.DlDF76X-.js";import{D as P}from"../chunks/Details.CcnKeIbl.js";import{T as i}from"../chunks/Tome_Subheading.DfvSwAiN.js";import{U as nn}from"../chunks/Unfinished_Implementation_Warning.auQLELoI.js";const an=`/* @ryanatkn/moss/style_utilities.css */
...
`;var _n=e("Both the docs and implementation of these need more work.",1),on=e('<li class="svelte-1gekuvc"> </li>'),rn=e('<li class="svelte-1gekuvc"> </li>'),sn=e('<span class="font_mono">@ryanatkn/moss/style_utilities.css</span>'),ln=e('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_utilities.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),en=e('<span class="font_mono">@ryanatkn/moss/style_components.css</span>'),dn=e('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_components.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),cn=e(`<!> <section><!> <p>Moss has three optional CSS files with different kinds of classes:</p> <!> <p>Utility classes use plain CSS for convenient HTML authoring. Many are based on Moss style <!>.</p> <p>Component classes are semantic groupings of styles.</p> <aside>Unused clases can be removed with build tooling, which is out of scope for Moss, and with a
			more sophisticated architecture these classes could potentially be generated on demand instead
			of distributed as static files.</aside></section> <section><!> <ul class="classes unstyled svelte-1gekuvc"></ul></section> <section><!> <aside>These are like utility classes but don't map as cleanly to a single style property.</aside> <ul class="classes unstyled svelte-1gekuvc"></ul></section> <section><!> <!> <!></section>`,1);function Tn(R,B){H(B,!0);const E=Z("classes"),Y=["relative|absolute|fixed|sticky|static","overflow_auto|hidden|scroll|clip|visible","overflow_x|y_auto|hidden|scroll|clip|visible","inline|inline_block|block|flex|grid","display_none|contents","flex_1","float_none|left|right|inline_start|inline_end","flip_x|y|xy","font_sans|mono","line_height_xs-xl","size_xs-xl9","icon_size_xs-xl3","text_align_start|end|left|right|center|justify|justify_all|match_parent","vertical_align_baseline|sub|super|text_top|text_bottom|middle|top|bottom","font_weight_100-900","ellipsis","pixelated","text_1-3","darken|lighten_1-9","bg|fg","bg|fg_1-9","color_darken|lighten_1-9","color_bg|fg","color_bg|fg_1-9","hue_a-g","color_a-g_1 -9","bg_a-g_1-9","border_color_1-5","border_width_1-6","outline_width_1-3","border_none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset","radius_0|50|100","radius_xs3-xl","fade_0|100","fade_1-6","shadow_xs-xl","shadow_inset|outset_xs-xl","shadow_a-g_xs-xl","shadow_a-g_inset|outset_xs-xl","shadow_inherit|initial|none","w|h_0|100","w|h_xs-xl15","p|pt|pr|pb|pl|px|py_0","p|pt|pr|pb|pl|px|py_xs5-xl15","m|mx|my_auto","m|mt|mr|mb|ml|mx|my_0","m|mt|mr|mb|ml|mx|my_xs5-xl15","gap_xs5-xl15","column|row_gap_xs5-xl15"],N=["box","row","wrap|nowrap","formatted","width_xs-md","selectable","clickable","pane","panel","icon_button","plain","menu_item","chevron","chip"];K(R,{tome:E,children:(W,gn)=>{var w=cn(),u=m(w);nn(u,{children:(d,_)=>{var s=_n();l(d,s)},$$slots:{default:!0}});var p=n(n(u,!0)),f=r(p);i(f,{text:"Optional CSS classes",slug:"css-classes"});var X=n(n(f,!0)),k=n(n(X,!0));b(k,{content:`<!-- +layout.svelte -->
<script>
	...
	// ...
<\/script>`});var y=n(n(k,!0)),q=n(r(y));Q(q,{name:"variables"}),F(),t(y),t(p);var g=n(n(p,!0)),z=r(g);i(z,{text:"Utility classes",slug:"utility-classes"});var O=n(n(z,!0));I(O,73,()=>Y,U,(d,_,s)=>{var a=on(),o=r(a);t(a),C(()=>A(o,`.${j(_)??""}`)),l(d,a)}),t(O),t(g);var x=n(n(g,!0)),T=r(x);i(T,{text:"Component classes",slug:"semantic-classes"});var G=n(n(T,!0)),$=n(n(G,!0));I($,73,()=>N,U,(d,_,s)=>{var a=rn(),o=r(a);t(a),C(()=>A(o,`.${j(_)??""}`)),l(d,a)}),t($),t(x);var D=n(n(x,!0)),S=r(D);i(S,{text:"Raw CSS",slug:"raw-css"});var M=n(n(S,!0));P(M,{summary:_=>{var s=sn();l(_,s)},children:(_,s)=>{var a=ln(),o=m(a),c=r(o),v=r(c);L(v,{size:"var(--icon_size_xs)"}),t(c),t(o);var h=n(n(o,!0));b(h,{content:an,lang:"css"}),l(_,a)},$$slots:{default:!0}});var J=n(n(M,!0));P(J,{summary:_=>{var s=en();l(_,s)},children:(_,s)=>{var a=dn(),o=m(a),c=r(o),v=r(c);L(v,{size:"var(--icon_size_xs)"}),t(c),t(o);var h=n(n(o,!0));b(h,{content:tn,lang:"css"}),l(_,a)},$$slots:{default:!0}}),t(D),l(W,w)},$$slots:{default:!0}}),V()}export{Tn as component};
