import{a as s,t as l,f as g,c as _,b as n,s as T}from"../chunks/disclose-version.Dj_2BLBP.js";import{p as F,a as H,t as $,D}from"../chunks/runtime.DKCg-osn.js";import{g as S,i as M}from"../chunks/attributes.BdgSbWfL.js";import{C as x}from"../chunks/Code.KxK97Poa.js";import{T as J}from"../chunks/Tome_Detail.CgYZVSDo.js";import{T as V}from"../chunks/Tome_Link.CAW6Qk6E.js";import{G as C}from"../chunks/Github_Logo.Bq6ykiWI.js";import{a as K}from"../chunks/tome.BQsYDXN1.js";import{D as j}from"../chunks/Details.04ACoP7t.js";import{T as d}from"../chunks/Tome_Subheading.BOFzYNOz.js";import{U as Q}from"../chunks/Unfinished_Implementation_Warning.X1eaJbBC.js";const Z=`/* @ryanatkn/moss/style_utilities.css */
...
`,nn=`/* @ryanatkn/moss/style_components.css */
...
`;var an=l("Both the docs and implementation of these need more work.",1),tn=l('<li class="svelte-1gekuvc"> </li>'),_n=l('<li class="svelte-1gekuvc"> </li>'),on=l('<span class="font_mono">@ryanatkn/moss/style_utilities.css</span>'),rn=l('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_utilities.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),sn=l('<span class="font_mono">@ryanatkn/moss/style_components.css</span>'),ln=l('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_components.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),en=l(`<!> <section><!> <p>Moss has three optional CSS files with different kinds of classes:</p> <!> <p>Utility classes use plain CSS for convenient HTML authoring. Many are based on Moss style <!>.</p> <p>Component classes are semantic groupings of styles.</p> <aside>Unused clases can be removed with build tooling, which is out of scope for Moss, and with a
			more sophisticated architecture these classes could potentially be generated on demand instead
			of distributed as static files.</aside></section> <section><!> <ul class="classes unstyled svelte-1gekuvc"></ul></section> <section><!> <aside>These are like utility classes but don't map as cleanly to a single style property.</aside> <ul class="classes unstyled svelte-1gekuvc"></ul></section> <section><!> <!> <!></section>`,1);function yn(A,I){F(I,!0);const U=K("classes"),L=["relative|absolute|fixed|sticky|static","overflow_auto|hidden|scroll|clip|visible","overflow_x|y_auto|hidden|scroll|clip|visible","inline|inline_block|block|flex|grid","display_none|contents","flex_1","box","row","wrap|nowrap","float_none|left|right|inline_start|inline_end","flip_x|y|xy","font_sans|mono","line_height","line_height_xs-xl","size_xs-xl9","icon_size_xs-xl2","text_align_center|right|left|justify","font_weight_100-900","ellipsis","pixelated","text_1-3","darken|lighten_1-9","bg|fg","bg|fg_1-9","color_darken|lighten_1-9","color_bg|fg","color_bg|fg_1-9","hue_a-g","color_a-g_1 -9","bg_a-g_1-9","border_color_1-5","border_width_1-6","outline_width_1-3","border_none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset","radius_0|50|100","radius_xs3-xl","fade_0|100","fade_1-6","shadow_xs-xl","shadow_inset|outset_xs-xl","shadow_inherit|initial|none","w|h_0|100","w|h_xs-xl15","p|pt|pr|pb|pl|px|py_0","p|pt|pr|pb|pl|px|py_xs5-xl15","m|mx|my_auto","m|mt|mr|mb|ml|mx|my_0","m|mt|mr|mb|ml|mx|my_xs5-xl15","gap_xs5-xl15","row|column_gap_xs5-xl15"],P=["selectable","pane","panel","icon_button","plain","menu_item","chevron","chip","formatted","width_xs-md"];J(A,{tome:U,children:(R,cn)=>{var v=en(),m=g(v);Q(m,{children:(e,a)=>{var o=an();s(e,o)},$$slots:{default:!0}});var h=n(n(m,!0)),b=_(h);d(b,{text:"Optional CSS classes",slug:"css-classes"});var B=n(n(b,!0)),w=n(n(B,!0));x(w,{content:`<!-- +layout.svelte -->
<script>
	...
	// ...`});var E=n(n(w,!0)),Y=n(_(E));V(Y,{name:"variables"});var u=n(n(h,!0)),f=_(u);d(f,{text:"Utility classes",slug:"utility-classes"});var N=n(n(f,!0));S(N,73,()=>L,M,(e,a,o)=>{var t=tn(),r=_(t);$(()=>T(r,`.${D(a)??""}`)),s(e,t)});var k=n(n(u,!0)),y=_(k);d(y,{text:"Component classes",slug:"semantic-classes"});var W=n(n(y,!0)),X=n(n(W,!0));S(X,73,()=>P,M,(e,a,o)=>{var t=_n(),r=_(t);$(()=>T(r,`.${D(a)??""}`)),s(e,t)});var q=n(n(k,!0)),z=_(q);d(z,{text:"Raw CSS",slug:"raw-css"});var O=n(n(z,!0));j(O,{summary:a=>{var o=on();s(a,o)},children:(a,o)=>{var t=rn(),r=g(t),c=_(r),i=_(c);C(i,{size:"var(--icon_size_xs)"});var p=n(n(r,!0));x(p,{content:Z,lang:"css"}),s(a,t)},$$slots:{default:!0}});var G=n(n(O,!0));j(G,{summary:a=>{var o=sn();s(a,o)},children:(a,o)=>{var t=ln(),r=g(t),c=_(r),i=_(c);C(i,{size:"var(--icon_size_xs)"});var p=n(n(r,!0));x(p,{content:nn,lang:"css"}),s(a,t)},$$slots:{default:!0}}),s(R,v)},$$slots:{default:!0}}),H()}export{yn as component};
