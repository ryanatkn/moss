import{b as J,a as s,t as d}from"../chunks/disclose-version.DMh2gfYs.js";import{p as F,a as H,f as m,n as i,s as o,c as r,r as a,t as M,Q as I}from"../chunks/runtime.tSR6J6RN.js";import{s as A}from"../chunks/render.rKr1cOry.js";import{e as U,i as L}from"../chunks/class.m1pjHSW2.js";import{C as b}from"../chunks/Code.DZPYEKk2.js";import{T as Q}from"../chunks/Tome_Detail.Dn31Qfto.js";import{T as V}from"../chunks/Tome_Link.D0QzVn6F.js";import{G as P}from"../chunks/Github_Logo.D5CytRM8.js";import{a as K}from"../chunks/tome.ChykMuhe.js";import{D as R}from"../chunks/Details.JNm7NCLD.js";import{T as h}from"../chunks/Tome_Subheading.CPS8FFs8.js";import{U as Z}from"../chunks/Unfinished_Implementation_Warning.BLAidMVf.js";const nn=`/* @ryanatkn/moss/style_utilities.css */
...
<script>
	...
	// ...
<\/script>`});var z=o(k,2),q=o(r(z));V(q,{name:"variables"}),i(),a(z),i(4),a(x);var v=o(x,2),O=r(v);h(O,{text:"Utility classes",slug:"utility-classes"});var j=o(O,2);U(j,21,()=>Y,L,(l,_)=>{var n=an(),t=r(n);a(n),M(()=>A(t,`.${I(_)??""}`)),s(l,n)}),a(j),a(v);var g=o(v,2),T=r(g);h(T,{text:"Component classes",slug:"semantic-classes"});var D=o(T,4);U(D,21,()=>N,L,(l,_)=>{var n=_n(),t=r(n);a(n),M(()=>A(t,`.${I(_)??""}`)),s(l,n)}),a(D),a(g);var S=o(g,2),$=r(S);h($,{text:"Raw CSS",slug:"raw-css"});var C=o($,2);R(C,{summary:_=>{var n=rn();s(_,n)},children:(_,n)=>{var t=tn(),e=m(t),c=r(e),p=r(c);P(p,{size:"var(--icon_size_xs)"}),i(2),a(c),a(e);var w=o(e,2);b(w,{content:nn,lang:"css"}),s(_,t)},$$slots:{default:!0}});var G=o(C,2);R(G,{summary:_=>{var n=sn();s(_,n)},children:(_,n)=>{var t=ln(),e=m(t),c=r(e),p=r(c);P(p,{size:"var(--icon_size_xs)"}),i(2),a(c),a(e);var w=o(e,2);b(w,{content:on,lang:"css"}),s(_,t)},$$slots:{default:!0}}),a(S),s(X,u)},$$slots:{default:!0}}),H()}export{zn as component};
