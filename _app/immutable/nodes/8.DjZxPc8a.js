import{b as J,a as l,t as c}from"../chunks/disclose-version.CYUEkZ6s.js";import{p as F,a as H,f as b,n as p,s as a,c as o,r as t,t as M,Q as I}from"../chunks/runtime.DvazHU5t.js";import{s as A}from"../chunks/render.Cpb4M2J0.js";import{e as U,i as L}from"../chunks/class.an1nRhKd.js";import{C as w}from"../chunks/Code.BpqY8T6K.js";import{T as Q}from"../chunks/Tome_Detail.BT801zO2.js";import{T as V}from"../chunks/Tome_Link.B2SArEWX.js";import{G as P}from"../chunks/Github_Logo.C2KHkuON.js";import{a as K}from"../chunks/tome.CWwvXkAA.js";import{D as R}from"../chunks/Details.eLJkvB1t.js";import{T as d}from"../chunks/Tome_Subheading.B8t8gskZ.js";import{U as Z}from"../chunks/Unfinished_Implementation_Warning.D94y4Otm.js";const nn=`/* @ryanatkn/moss/style_utilities.css */
...
`,an=`/* @ryanatkn/moss/style_components.css */
...
.pane {
	...
	box-shadow: var(--pane_shadow, var(--shadow_md) var(--shadow_color));
	border-radius: var(--radius_xs);
}
...
`;var tn=c('<li class="svelte-1gekuvc"> </li>'),rn=c('<li class="svelte-1gekuvc"> </li>'),on=c('<span class="font_mono">@ryanatkn/moss/style_utilities.css</span>'),_n=c('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_utilities.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),ln=c('<span class="font_mono">@ryanatkn/moss/style_components.css</span>'),en=c('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_components.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),sn=c(`<!> <section><!> <p>Moss has three optional CSS files with different kinds of classes:</p> <!> <p>Utility classes use plain CSS for convenient HTML authoring. Many are based on Moss style <!>.</p> <p>Component classes are semantic groupings of styles.</p> <aside>Unused clases can be removed with build tooling, which is out of scope for Moss, and with a
...
<script>
	...
	// ...
<\/script>`});var z=a(k,2),q=a(o(z));V(q,{name:"variables"}),p(),t(z),p(4),t(g);var x=a(g,2),O=o(x);d(O,{text:"Utility classes",slug:"utility-classes"});var j=a(O,2);U(j,21,()=>Y,L,(e,r)=>{var n=tn(),_=o(n);t(n),M(()=>A(_,`.${I(r)??""}`)),l(e,n)}),t(j),t(x);var v=a(x,2),T=o(v);d(T,{text:"Component classes",slug:"semantic-classes"});var D=a(T,4);U(D,21,()=>N,L,(e,r)=>{var n=rn(),_=o(n);t(n),M(()=>A(_,`.${I(r)??""}`)),l(e,n)}),t(D),t(v);var S=a(v,2),$=o(S);d($,{text:"Raw CSS",slug:"raw-css"});var C=a($,2);R(C,{summary:r=>{var n=on();l(r,n)},children:(r,n)=>{var _=_n(),s=b(_),i=o(s),h=o(i);P(h,{size:"var(--icon_size_xs)"}),p(2),t(i),t(s);var m=a(s,2);w(m,{content:nn,lang:"css"}),l(r,_)},$$slots:{default:!0}});var G=a(C,2);R(G,{summary:r=>{var n=ln();l(r,n)},children:(r,n)=>{var _=en(),s=b(_),i=o(s),h=o(i);P(h,{size:"var(--icon_size_xs)"}),p(2),t(i),t(s);var m=a(s,2);w(m,{content:an,lang:"css"}),l(r,_)},$$slots:{default:!0}}),t(S),l(X,f)},$$slots:{default:!0}}),H()}export{zn as component};
