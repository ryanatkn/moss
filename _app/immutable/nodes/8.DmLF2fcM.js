import{d as V,a as s,t as e,f as d,c as _,b as n,s as $}from"../chunks/disclose-version.YLdr8toi.js";import{p as K,a as Q,t as D,X as S}from"../chunks/runtime.BCD8ssac.js";import{g as M,i as C}from"../chunks/attributes.Dtd4ZxzV.js";import{C as x}from"../chunks/Code.B-A2CnPe.js";import{T as Z}from"../chunks/Tome_Detail.Ow31VTLU.js";import{T as nn}from"../chunks/Tome_Link.C_m5QPxU.js";import{G as j}from"../chunks/Github_Logo.Bc68Xldn.js";import{a as an}from"../chunks/tome.4aA1IwVf.js";import{D as A}from"../chunks/Details.BP6EEald.js";import{T as c}from"../chunks/Tome_Subheading.DrLhd37_.js";import{U as tn}from"../chunks/Unfinished_Implementation_Warning.W01CUZ0s.js";const _n=`/* @ryanatkn/moss/style_utilities.css */
...
`;var rn=e("Both the docs and implementation of these need more work.",1),sn=e('<li class="svelte-1gekuvc"> </li>'),ln=e('<li class="svelte-1gekuvc"> </li>'),en=e('<span class="font_mono">@ryanatkn/moss/style_utilities.css</span>'),dn=e('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_utilities.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),cn=e('<span class="font_mono">@ryanatkn/moss/style_components.css</span>'),pn=e('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_components.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),gn=e(`<!> <section><!> <p>Moss has three optional CSS files with different kinds of classes:</p> <!> <p>Utility classes use plain CSS for convenient HTML authoring. Many are based on Moss style <!>.</p> <p>Component classes are semantic groupings of styles.</p> <aside>Unused clases can be removed with build tooling, which is out of scope for Moss, and with a
			more sophisticated architecture these classes could potentially be generated on demand instead
			of distributed as static files.</aside></section> <section><!> <ul class="classes unstyled svelte-1gekuvc"></ul></section> <section><!> <aside>These are like utility classes but don't map as cleanly to a single style property.</aside> <ul class="classes unstyled svelte-1gekuvc"></ul></section> <section><!> <!> <!></section>`,1);function $n(I,U){K(U,!0);const L=an("classes"),P=["relative|absolute|fixed|sticky|static","overflow_auto|hidden|scroll|clip|visible","overflow_x|y_auto|hidden|scroll|clip|visible","inline|inline_block|block|flex|grid","display_none|contents","flex_1","box","row","wrap|nowrap","float_none|left|right|inline_start|inline_end","flip_x|y|xy","font_sans|mono","line_height","line_height_xs-xl","size_xs-xl9","icon_size_xs-xl2","text_align_center|right|left|justify","font_weight_100-900","ellipsis","pixelated","text_1-3","darken|lighten_1-9","bg|fg","bg|fg_1-9","color_darken|lighten_1-9","color_bg|fg","color_bg|fg_1-9","hue_a-g","color_a-g_1 -9","bg_a-g_1-9","border_color_1-5","border_width_1-6","outline_width_1-3","border_none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset","radius_0|50|100","radius_xs3-xl","fade_0|100","fade_1-6","shadow_xs-xl","shadow_inset|outset_xs-xl","shadow_inherit|initial|none","w|h_0|100","w|h_xs-xl15","p|pt|pr|pb|pl|px|py_0","p|pt|pr|pb|pl|px|py_xs5-xl15","m|mx|my_auto","m|mt|mr|mb|ml|mx|my_0","m|mt|mr|mb|ml|mx|my_xs5-xl15","gap_xs5-xl15","row|column_gap_xs5-xl15"],R=["selectable","pane","panel","icon_button","plain","menu_item","chevron","chip","formatted","width_xs-md"];var v=V(),B=d(v);Z(B,{tome:L,children:(E,vn)=>{var m=gn(),h=d(m);tn(h,{children:(o,a)=>{var r=rn();s(o,r)},$$slots:{default:!0}});var b=n(n(h,!0)),w=_(b);c(w,{text:"Optional CSS classes",slug:"css-classes"});var X=n(n(w,!0)),u=n(n(X,!0));x(u,{content:`<!-- +layout.svelte -->
<script>
	...
	// ...`});var Y=n(n(u,!0)),N=n(_(Y));nn(N,{name:"variables"});var f=n(n(b,!0)),k=_(f);c(k,{text:"Utility classes",slug:"utility-classes"});var W=n(n(k,!0));M(W,73,()=>P,C,(o,a,r)=>{var t=sn(),l=_(t);D(()=>$(l,`.${S(a)??""}`)),s(o,t)});var y=n(n(f,!0)),z=_(y);c(z,{text:"Component classes",slug:"semantic-classes"});var q=n(n(z,!0)),G=n(n(q,!0));M(G,73,()=>R,C,(o,a,r)=>{var t=ln(),l=_(t);D(()=>$(l,`.${S(a)??""}`)),s(o,t)});var F=n(n(y,!0)),O=_(F);c(O,{text:"Raw CSS",slug:"raw-css"});var T=n(n(O,!0));{var i=o=>{var a=en();s(o,a)};A(T,{summary:i,children:(o,a)=>{var r=dn(),t=d(r),l=_(t),p=_(l);j(p,{size:"var(--icon_size_xs)"});var g=n(n(t,!0));x(g,{content:_n,lang:"css"}),s(o,r)},$$slots:{default:!0}})}var H=n(n(T,!0));{var i=a=>{var r=cn();s(a,r)};A(H,{summary:i,children:(a,r)=>{var t=pn(),l=d(t),p=_(l),g=_(p);j(g,{size:"var(--icon_size_xs)"});var J=n(n(l,!0));x(J,{content:on,lang:"css"}),s(a,t)},$$slots:{default:!0}})}s(E,m)},$$slots:{default:!0}}),s(I,v),Q()}export{$n as component};
