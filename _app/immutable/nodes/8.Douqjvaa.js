import{b as J,a as s,t as c}from"../chunks/disclose-version.BUQKzkHR.js";import{p as F,a as H,f as w,T as i,s as a,c as t,r as o,t as M,P as I}from"../chunks/runtime.B3w0Sz81.js";import{s as A}from"../chunks/render.CMkdwi7K.js";import{e as U,i as P}from"../chunks/class.OuJpC35m.js";import{C as b}from"../chunks/Code.B5NC9bOb.js";import{T as V}from"../chunks/Tome_Detail.BPsHww5m.js";import{T as K}from"../chunks/Tome_Link.D6sZz34x.js";import{G as L}from"../chunks/Github_Logo.Csp5p1_1.js";import{a as Q}from"../chunks/tome.D6vM4_17.js";import{D as R}from"../chunks/Details.Dn2JYvJs.js";import{T as g}from"../chunks/Tome_Subheading.BqsuOXhe.js";import{U as Z}from"../chunks/Unfinished_Implementation_Warning.DkBbiAG1.js";const nn=`/* @ryanatkn/moss/style_utilities.css */
...
`;var on=c('<li class="svelte-1gekuvc"> </li>'),_n=c('<li class="svelte-1gekuvc"> </li>'),tn=c('<span class="font_mono">@ryanatkn/moss/style_utilities.css</span>'),rn=c('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_utilities.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),sn=c('<span class="font_mono">@ryanatkn/moss/style_components.css</span>'),ln=c('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_components.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),en=c(`<!> <section><!> <p>Moss has three optional CSS files with different kinds of classes:</p> <!> <p>Utility classes use plain CSS for convenient HTML authoring. Many are based on Moss style <!>.</p> <p>Component classes are semantic groupings of styles.</p> <aside>Unused clases can be removed with build tooling, which is out of scope for Moss, and with a
...
<script>
	...
	// ...
<\/script>`});var z=a(k,2),q=a(t(z));K(q,{name:"variables"}),i(),o(z),i(4),o(p);var h=a(p,2),j=t(h);g(j,{text:"Utility classes",slug:"utility-classes"});var O=a(j,2);U(O,21,()=>Y,P,(l,_)=>{var n=on(),r=t(n);o(n),M(()=>A(r,`.${I(_)??""}`)),s(l,n)}),o(O),o(h);var v=a(h,2),T=t(v);g(T,{text:"Component classes",slug:"semantic-classes"});var D=a(T,4);U(D,21,()=>N,P,(l,_)=>{var n=_n(),r=t(n);o(n),M(()=>A(r,`.${I(_)??""}`)),s(l,n)}),o(D),o(v);var S=a(v,2),$=t(S);g($,{text:"Raw CSS",slug:"raw-css"});var C=a($,2);R(C,{summary:_=>{var n=tn();s(_,n)},children:(_,n)=>{var r=rn(),e=w(r),d=t(e),x=t(d);L(x,{size:"var(--icon_size_xs)"}),i(2),o(d),o(e);var m=a(e,2);b(m,{content:nn,lang:"css"}),s(_,r)},$$slots:{default:!0}});var G=a(C,2);R(G,{summary:_=>{var n=sn();s(_,n)},children:(_,n)=>{var r=ln(),e=w(r),d=t(e),x=t(d);L(x,{size:"var(--icon_size_xs)"}),i(2),o(d),o(e);var m=a(e,2);b(m,{content:an,lang:"css"}),s(_,r)},$$slots:{default:!0}}),o(S),s(X,u)},$$slots:{default:!0}}),H()}export{zn as component};
