import{b as J,a as s,t as d}from"../chunks/disclose-version.BUQKzkHR.js";import{p as F,a as H,f as m,T as i,s as o,c as r,r as a,t as M,P as I}from"../chunks/runtime.B3w0Sz81.js";import{s as A}from"../chunks/render.CMkdwi7K.js";import{e as U,i as P}from"../chunks/class.OuJpC35m.js";import{C as b}from"../chunks/Code.B5NC9bOb.js";import{T as V}from"../chunks/Tome_Detail.BHHsat3u.js";import{T as K}from"../chunks/Tome_Link.DvMdlaCQ.js";import{G as L}from"../chunks/Github_Logo.Csp5p1_1.js";import{a as Q}from"../chunks/tome.D6vM4_17.js";import{D as R}from"../chunks/Details.Dn2JYvJs.js";import{T as h}from"../chunks/Tome_Subheading.B1RNGqnu.js";import{U as Z}from"../chunks/Unfinished_Implementation_Warning.DkBbiAG1.js";const nn=`/* @ryanatkn/moss/style_utilities.css */
...
.shadow_outer_xs {
	box-shadow: var(--shadow_outer_xs) var(--shadow_color_1);
}
.shadow_outer_sm {
	box-shadow: var(--shadow_outer_sm) var(--shadow_color_2);
}
.shadow_outer_md {
	box-shadow: var(--shadow_outer_md) var(--shadow_color_3);
}
.shadow_outer_lg {
	box-shadow: var(--shadow_outer_lg) var(--shadow_color_4);
}
.shadow_outer_xl {
	box-shadow: var(--shadow_outer_xl) var(--shadow_color_5);
}
.shadow_inner_xs {
	box-shadow: var(--shadow_inner_xs) var(--shadow_color_1);
}
.shadow_inner_sm {
	box-shadow: var(--shadow_inner_sm) var(--shadow_color_2);
}
.shadow_inner_md {
	box-shadow: var(--shadow_inner_md) var(--shadow_color_3);
}
.shadow_inner_lg {
	box-shadow: var(--shadow_inner_lg) var(--shadow_color_4);
}
.shadow_inner_xl {
	box-shadow: var(--shadow_inner_xl) var(--shadow_color_5);
}
...
.highlight_outer_xs {
	box-shadow: var(--shadow_outer_xs) var(--highlight_color_1);
}
.highlight_outer_sm {
	box-shadow: var(--shadow_outer_sm) var(--highlight_color_2);
}
.highlight_outer_md {
	box-shadow: var(--shadow_outer_md) var(--highlight_color_3);
}
.highlight_outer_lg {
	box-shadow: var(--shadow_outer_lg) var(--highlight_color_4);
}
.highlight_outer_xl {
	box-shadow: var(--shadow_outer_xl) var(--highlight_color_5);
}
.highlight_inner_xs {
	box-shadow: var(--shadow_inner_xs) var(--highlight_color_1);
}
.highlight_inner_sm {
	box-shadow: var(--shadow_inner_sm) var(--highlight_color_2);
}
.highlight_inner_md {
	box-shadow: var(--shadow_inner_md) var(--highlight_color_3);
}
.highlight_inner_lg {
	box-shadow: var(--shadow_inner_lg) var(--highlight_color_4);
}
.highlight_inner_xl {
	box-shadow: var(--shadow_inner_xl) var(--highlight_color_5);
}
...
.glow_outer_xs {
	box-shadow: var(--shadow_outer_xs) var(--glow_color_1);
}
.glow_outer_sm {
	box-shadow: var(--shadow_outer_sm) var(--glow_color_2);
}
.glow_outer_md {
	box-shadow: var(--shadow_outer_md) var(--glow_color_3);
}
.glow_outer_lg {
	box-shadow: var(--shadow_outer_lg) var(--glow_color_4);
}
.glow_outer_xl {
	box-shadow: var(--shadow_outer_xl) var(--glow_color_5);
}
.glow_inner_xs {
	box-shadow: var(--shadow_inner_xs) var(--glow_color_1);
}
.glow_inner_sm {
	box-shadow: var(--shadow_inner_sm) var(--glow_color_2);
}
.glow_inner_md {
	box-shadow: var(--shadow_inner_md) var(--glow_color_3);
}
.glow_inner_lg {
	box-shadow: var(--shadow_inner_lg) var(--glow_color_4);
}
.glow_inner_xl {
	box-shadow: var(--shadow_inner_xl) var(--glow_color_5);
}
...
.shroud_outer_xs {
	box-shadow: var(--shadow_outer_xs) var(--shroud_color_1);
}
.shroud_outer_sm {
	box-shadow: var(--shadow_outer_sm) var(--shroud_color_2);
}
.shroud_outer_md {
	box-shadow: var(--shadow_outer_md) var(--shroud_color_3);
}
.shroud_outer_lg {
	box-shadow: var(--shadow_outer_lg) var(--shroud_color_4);
}
.shroud_outer_xl {
	box-shadow: var(--shadow_outer_xl) var(--shroud_color_5);
}
.shroud_inner_xs {
	box-shadow: var(--shadow_inner_xs) var(--shroud_color_1);
}
.shroud_inner_sm {
	box-shadow: var(--shadow_inner_sm) var(--shroud_color_2);
}
.shroud_inner_md {
	box-shadow: var(--shadow_inner_md) var(--shroud_color_3);
}
.shroud_inner_lg {
	box-shadow: var(--shadow_inner_lg) var(--shroud_color_4);
}
.shroud_inner_xl {
	box-shadow: var(--shadow_inner_xl) var(--shroud_color_5);
}
...
.shadow_a_outer_xs {
	box-shadow: var(--shadow_outer_xs) var(--shadow_color_a_1);
}
.shadow_a_outer_sm {
	box-shadow: var(--shadow_outer_sm) var(--shadow_color_a_2);
}
.shadow_a_outer_md {
	box-shadow: var(--shadow_outer_md) var(--shadow_color_a_3);
}
.shadow_a_outer_lg {
	box-shadow: var(--shadow_outer_lg) var(--shadow_color_a_4);
}
.shadow_a_outer_xl {
	box-shadow: var(--shadow_outer_xl) var(--shadow_color_a_5);
}
.shadow_a_inner_xs {
	box-shadow: var(--shadow_inner_xs) var(--shadow_color_a_1);
}
.shadow_a_inner_sm {
	box-shadow: var(--shadow_inner_sm) var(--shadow_color_a_2);
}
.shadow_a_inner_md {
	box-shadow: var(--shadow_inner_md) var(--shadow_color_a_3);
}
.shadow_a_inner_lg {
	box-shadow: var(--shadow_inner_lg) var(--shadow_color_a_4);
}
.shadow_a_inner_xl {
	box-shadow: var(--shadow_inner_xl) var(--shadow_color_a_5);
}
.shadow_b_xs {
...
.shadow_b_outer_xs {
	box-shadow: var(--shadow_outer_xs) var(--shadow_color_b_1);
}
.shadow_b_outer_sm {
	box-shadow: var(--shadow_outer_sm) var(--shadow_color_b_2);
}
.shadow_b_outer_md {
	box-shadow: var(--shadow_outer_md) var(--shadow_color_b_3);
}
.shadow_b_outer_lg {
	box-shadow: var(--shadow_outer_lg) var(--shadow_color_b_4);
}
.shadow_b_outer_xl {
	box-shadow: var(--shadow_outer_xl) var(--shadow_color_b_5);
}
.shadow_b_inner_xs {
	box-shadow: var(--shadow_inner_xs) var(--shadow_color_b_1);
}
.shadow_b_inner_sm {
	box-shadow: var(--shadow_inner_sm) var(--shadow_color_b_2);
}
.shadow_b_inner_md {
	box-shadow: var(--shadow_inner_md) var(--shadow_color_b_3);
}
.shadow_b_inner_lg {
	box-shadow: var(--shadow_inner_lg) var(--shadow_color_b_4);
}
.shadow_b_inner_xl {
	box-shadow: var(--shadow_inner_xl) var(--shadow_color_b_5);
}
.shadow_c_xs {
...
.shadow_c_outer_xs {
	box-shadow: var(--shadow_outer_xs) var(--shadow_color_c_1);
}
.shadow_c_outer_sm {
	box-shadow: var(--shadow_outer_sm) var(--shadow_color_c_2);
}
.shadow_c_outer_md {
	box-shadow: var(--shadow_outer_md) var(--shadow_color_c_3);
}
.shadow_c_outer_lg {
	box-shadow: var(--shadow_outer_lg) var(--shadow_color_c_4);
}
.shadow_c_outer_xl {
	box-shadow: var(--shadow_outer_xl) var(--shadow_color_c_5);
}
.shadow_c_inner_xs {
	box-shadow: var(--shadow_inner_xs) var(--shadow_color_c_1);
}
.shadow_c_inner_sm {
	box-shadow: var(--shadow_inner_sm) var(--shadow_color_c_2);
}
.shadow_c_inner_md {
	box-shadow: var(--shadow_inner_md) var(--shadow_color_c_3);
}
.shadow_c_inner_lg {
	box-shadow: var(--shadow_inner_lg) var(--shadow_color_c_4);
}
.shadow_c_inner_xl {
	box-shadow: var(--shadow_inner_xl) var(--shadow_color_c_5);
}
.shadow_d_xs {
...
.shadow_d_outer_xs {
	box-shadow: var(--shadow_outer_xs) var(--shadow_color_d_1);
}
.shadow_d_outer_sm {
	box-shadow: var(--shadow_outer_sm) var(--shadow_color_d_2);
}
.shadow_d_outer_md {
	box-shadow: var(--shadow_outer_md) var(--shadow_color_d_3);
}
.shadow_d_outer_lg {
	box-shadow: var(--shadow_outer_lg) var(--shadow_color_d_4);
}
.shadow_d_outer_xl {
	box-shadow: var(--shadow_outer_xl) var(--shadow_color_d_5);
}
.shadow_d_inner_xs {
	box-shadow: var(--shadow_inner_xs) var(--shadow_color_d_1);
}
.shadow_d_inner_sm {
	box-shadow: var(--shadow_inner_sm) var(--shadow_color_d_2);
}
.shadow_d_inner_md {
	box-shadow: var(--shadow_inner_md) var(--shadow_color_d_3);
}
.shadow_d_inner_lg {
	box-shadow: var(--shadow_inner_lg) var(--shadow_color_d_4);
}
.shadow_d_inner_xl {
	box-shadow: var(--shadow_inner_xl) var(--shadow_color_d_5);
}
.shadow_e_xs {
...
.shadow_e_outer_xs {
	box-shadow: var(--shadow_outer_xs) var(--shadow_color_e_1);
}
.shadow_e_outer_sm {
	box-shadow: var(--shadow_outer_sm) var(--shadow_color_e_2);
}
.shadow_e_outer_md {
	box-shadow: var(--shadow_outer_md) var(--shadow_color_e_3);
}
.shadow_e_outer_lg {
	box-shadow: var(--shadow_outer_lg) var(--shadow_color_e_4);
}
.shadow_e_outer_xl {
	box-shadow: var(--shadow_outer_xl) var(--shadow_color_e_5);
}
.shadow_e_inner_xs {
	box-shadow: var(--shadow_inner_xs) var(--shadow_color_e_1);
}
.shadow_e_inner_sm {
	box-shadow: var(--shadow_inner_sm) var(--shadow_color_e_2);
}
.shadow_e_inner_md {
	box-shadow: var(--shadow_inner_md) var(--shadow_color_e_3);
}
.shadow_e_inner_lg {
	box-shadow: var(--shadow_inner_lg) var(--shadow_color_e_4);
}
.shadow_e_inner_xl {
	box-shadow: var(--shadow_inner_xl) var(--shadow_color_e_5);
}
.shadow_f_xs {
...
.shadow_f_outer_xs {
	box-shadow: var(--shadow_outer_xs) var(--shadow_color_f_1);
}
.shadow_f_outer_sm {
	box-shadow: var(--shadow_outer_sm) var(--shadow_color_f_2);
}
.shadow_f_outer_md {
	box-shadow: var(--shadow_outer_md) var(--shadow_color_f_3);
}
.shadow_f_outer_lg {
	box-shadow: var(--shadow_outer_lg) var(--shadow_color_f_4);
}
.shadow_f_outer_xl {
	box-shadow: var(--shadow_outer_xl) var(--shadow_color_f_5);
}
.shadow_f_inner_xs {
	box-shadow: var(--shadow_inner_xs) var(--shadow_color_f_1);
}
.shadow_f_inner_sm {
	box-shadow: var(--shadow_inner_sm) var(--shadow_color_f_2);
}
.shadow_f_inner_md {
	box-shadow: var(--shadow_inner_md) var(--shadow_color_f_3);
}
.shadow_f_inner_lg {
	box-shadow: var(--shadow_inner_lg) var(--shadow_color_f_4);
}
.shadow_f_inner_xl {
	box-shadow: var(--shadow_inner_xl) var(--shadow_color_f_5);
}
.shadow_g_xs {
...
.shadow_g_outer_xs {
	box-shadow: var(--shadow_outer_xs) var(--shadow_color_g_1);
}
.shadow_g_outer_sm {
	box-shadow: var(--shadow_outer_sm) var(--shadow_color_g_2);
}
.shadow_g_outer_md {
	box-shadow: var(--shadow_outer_md) var(--shadow_color_g_3);
}
.shadow_g_outer_lg {
	box-shadow: var(--shadow_outer_lg) var(--shadow_color_g_4);
}
.shadow_g_outer_xl {
	box-shadow: var(--shadow_outer_xl) var(--shadow_color_g_5);
}
.shadow_g_inner_xs {
	box-shadow: var(--shadow_inner_xs) var(--shadow_color_g_1);
}
.shadow_g_inner_sm {
	box-shadow: var(--shadow_inner_sm) var(--shadow_color_g_2);
}
.shadow_g_inner_md {
	box-shadow: var(--shadow_inner_md) var(--shadow_color_g_3);
}
.shadow_g_inner_lg {
	box-shadow: var(--shadow_inner_lg) var(--shadow_color_g_4);
}
.shadow_g_inner_xl {
	box-shadow: var(--shadow_inner_xl) var(--shadow_color_g_5);
}
.shadow_h_xs {
...
.shadow_h_outer_xs {
	box-shadow: var(--shadow_outer_xs) var(--shadow_color_h_1);
}
.shadow_h_outer_sm {
	box-shadow: var(--shadow_outer_sm) var(--shadow_color_h_2);
}
.shadow_h_outer_md {
	box-shadow: var(--shadow_outer_md) var(--shadow_color_h_3);
}
.shadow_h_outer_lg {
	box-shadow: var(--shadow_outer_lg) var(--shadow_color_h_4);
}
.shadow_h_outer_xl {
	box-shadow: var(--shadow_outer_xl) var(--shadow_color_h_5);
}
.shadow_h_inner_xs {
	box-shadow: var(--shadow_inner_xs) var(--shadow_color_h_1);
}
.shadow_h_inner_sm {
	box-shadow: var(--shadow_inner_sm) var(--shadow_color_h_2);
}
.shadow_h_inner_md {
	box-shadow: var(--shadow_inner_md) var(--shadow_color_h_3);
}
.shadow_h_inner_lg {
	box-shadow: var(--shadow_inner_lg) var(--shadow_color_h_4);
}
.shadow_h_inner_xl {
	box-shadow: var(--shadow_inner_xl) var(--shadow_color_h_5);
}
.shadow_i_xs {
...
.shadow_i_outer_xs {
	box-shadow: var(--shadow_outer_xs) var(--shadow_color_i_1);
}
.shadow_i_outer_sm {
	box-shadow: var(--shadow_outer_sm) var(--shadow_color_i_2);
}
.shadow_i_outer_md {
	box-shadow: var(--shadow_outer_md) var(--shadow_color_i_3);
}
.shadow_i_outer_lg {
	box-shadow: var(--shadow_outer_lg) var(--shadow_color_i_4);
}
.shadow_i_outer_xl {
	box-shadow: var(--shadow_outer_xl) var(--shadow_color_i_5);
}
.shadow_i_inner_xs {
	box-shadow: var(--shadow_inner_xs) var(--shadow_color_i_1);
}
.shadow_i_inner_sm {
	box-shadow: var(--shadow_inner_sm) var(--shadow_color_i_2);
}
.shadow_i_inner_md {
	box-shadow: var(--shadow_inner_md) var(--shadow_color_i_3);
}
.shadow_i_inner_lg {
	box-shadow: var(--shadow_inner_lg) var(--shadow_color_i_4);
}
.shadow_i_inner_xl {
	box-shadow: var(--shadow_inner_xl) var(--shadow_color_i_5);
}
...
`;var an=d('<li class="svelte-1gekuvc"> </li>'),_n=d('<li class="svelte-1gekuvc"> </li>'),rn=d('<span class="font_mono">@ryanatkn/moss/style_utilities.css</span>'),tn=d('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_utilities.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),sn=d('<span class="font_mono">@ryanatkn/moss/style_components.css</span>'),ln=d('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_components.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),en=d(`<!> <section><!> <p>Moss has three optional CSS files with different kinds of classes:</p> <!> <p>Utility classes use plain CSS for convenient HTML authoring. Many are based on Moss style <!>.</p> <p>Component classes are semantic groupings of styles.</p> <aside>Unused clases can be removed with build tooling, which is out of scope for Moss, and with a
...
<script>
	...
	// ...
<\/script>`});var z=o(k,2),q=o(r(z));K(q,{name:"variables"}),i(),a(z),i(4),a(g);var v=o(g,2),j=r(v);h(j,{text:"Utility classes",slug:"utility-classes"});var O=o(j,2);U(O,21,()=>Y,P,(l,_)=>{var n=an(),t=r(n);a(n),M(()=>A(t,`.${I(_)??""}`)),s(l,n)}),a(O),a(v);var x=o(v,2),T=r(x);h(T,{text:"Component classes",slug:"semantic-classes"});var D=o(T,4);U(D,21,()=>N,P,(l,_)=>{var n=_n(),t=r(n);a(n),M(()=>A(t,`.${I(_)??""}`)),s(l,n)}),a(D),a(x);var S=o(x,2),$=r(S);h($,{text:"Raw CSS",slug:"raw-css"});var C=o($,2);R(C,{summary:_=>{var n=rn();s(_,n)},children:(_,n)=>{var t=tn(),e=m(t),c=r(e),w=r(c);L(w,{size:"var(--icon_size_xs)"}),i(2),a(c),a(e);var p=o(e,2);b(p,{content:nn,lang:"css"}),s(_,t)},$$slots:{default:!0}});var G=o(C,2);R(G,{summary:_=>{var n=sn();s(_,n)},children:(_,n)=>{var t=ln(),e=m(t),c=r(e),w=r(c);L(w,{size:"var(--icon_size_xs)"}),i(2),a(c),a(e);var p=o(e,2);b(p,{content:on,lang:"css"}),s(_,t)},$$slots:{default:!0}}),a(S),s(X,u)},$$slots:{default:!0}}),H()}export{zn as component};
