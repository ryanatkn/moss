import{a as r,t as l,b as N}from"../chunks/disclose-version.CdPiE6k7.js";import{p as X,f as g,a as q,n as m,s as t,c as x,r as c,t as D,F as S}from"../chunks/runtime.c_5Q9pFk.js";import{s as C}from"../chunks/render.CyQl6cMn.js";import{e as M,i as I}from"../chunks/class.DaKLncqJ.js";import{C as k}from"../chunks/Code.CdVYVEZR.js";import{T as F}from"../chunks/Tome_Content.f0VhGnET.js";import{T as G}from"../chunks/Tome_Link.U2HWPKp5.js";import{G as P}from"../chunks/Github_Logo.Dx1nFQI9.js";import{f as H}from"../chunks/tome.DmBdPuTz.js";import{D as A}from"../chunks/Details.BvGXqX2W.js";import{T as w,a as f}from"../chunks/Tome_Section_Header.B1hRAN3-.js";import{U as J}from"../chunks/Unfinished_Implementation_Warning.Bmn-vyW3.js";const V=`/* @ryanatkn/moss/style_utilities.css */
...
`,K=`/* @ryanatkn/moss/style_components.css */
...
<script>
	...
	// ...
<\/script>`});var i=t(_,2),p=t(x(i));G(p,{name:"variables"}),m(),c(i),m(4),r(e,a)},$$slots:{default:!0}});var T=t(j,2);w(T,{children:(e,b)=>{var a=nn(),o=g(a);f(o,{text:"Utility classes"});var _=t(o,2);M(_,21,()=>B,I,(i,p)=>{var n=Z(),s=x(n);c(n),D(()=>C(s,`.${S(p)??""}`)),r(i,n)}),c(_),r(e,a)},$$slots:{default:!0}});var $=t(T,2);w($,{children:(e,b)=>{var a=tn(),o=g(a);f(o,{text:"Component classes"});var _=t(o,4);M(_,21,()=>E,I,(i,p)=>{var n=an(),s=x(n);c(n),D(()=>C(s,`.${S(p)??""}`)),r(i,n)}),c(_),r(e,a)},$$slots:{default:!0}});var Y=t($,2);w(Y,{children:(e,b)=>{var a=en(),o=g(a);f(o,{text:"Raw CSS"});var _=t(o,2);A(_,{summary:n=>{var s=rn();r(n,s)},children:(n,s)=>{var v=on(),d=g(v),h=x(d),u=x(h);P(u,{size:"var(--icon_size_xs)"}),m(2),c(h),c(d);var y=t(d,2);k(y,{content:V,lang:"css"}),r(n,v)},$$slots:{default:!0}});var i=t(_,2);A(i,{summary:n=>{var s=_n();r(n,s)},children:(n,s)=>{var v=ln(),d=g(v),h=x(d),u=x(h);P(u,{size:"var(--icon_size_xs)"}),m(2),c(h),c(d);var y=t(d,2);k(y,{content:K,lang:"css"}),r(n,v)},$$slots:{default:!0}}),r(e,a)},$$slots:{default:!0}}),r(W,z)},$$slots:{default:!0}}),q()}export{zn as component};
