import{f as b,a as l,s as n,c as r,t as e,A as C,r as o}from"../chunks/disclose-version.gZ-2tz3Z.js";import{p as V,a as K,t as j,J as A}from"../chunks/runtime.4yfH9i_8.js";import{s as I}from"../chunks/render.nIEHh2HH.js";import{e as U,i as L}from"../chunks/attributes.CPiNokUc.js";import{C as w}from"../chunks/Code.Pz-7eqrk.js";import{T as Q}from"../chunks/Tome_Detail.DQIXniIx.js";import{T as Z}from"../chunks/Tome_Link.DTD1FsC5.js";import{G as P}from"../chunks/Github_Logo.Ddmgj9-e.js";import{a as nn}from"../chunks/tome.DlDF76X-.js";import{D as R}from"../chunks/Details.CmazD-f3.js";import{T as g}from"../chunks/Tome_Subheading.Dl8EBBcB.js";import{U as an}from"../chunks/Unfinished_Implementation_Warning.WKqJHAkV.js";const on=`/* @ryanatkn/moss/style_utilities.css */
...
.color_a_1 {
	color: hsl(var(--color_a_1));
}
.color_a_2 {
	color: hsl(var(--color_a_2));
}
.color_a_3 {
	color: hsl(var(--color_a_3));
}
.color_a_4 {
	color: hsl(var(--color_a_4));
}
.color_a_5 {
	color: hsl(var(--color_a_5));
}
.color_a_6 {
	color: hsl(var(--color_a_6));
}
.color_a_7 {
	color: hsl(var(--color_a_7));
}
.color_a_8 {
	color: hsl(var(--color_a_8));
}
.color_a_9 {
	color: hsl(var(--color_a_9));
}
.color_b_1 {
	color: hsl(var(--color_b_1));
}
.color_b_2 {
	color: hsl(var(--color_b_2));
}
.color_b_3 {
	color: hsl(var(--color_b_3));
}
.color_b_4 {
	color: hsl(var(--color_b_4));
}
.color_b_5 {
	color: hsl(var(--color_b_5));
}
.color_b_6 {
	color: hsl(var(--color_b_6));
}
.color_b_7 {
	color: hsl(var(--color_b_7));
}
.color_b_8 {
	color: hsl(var(--color_b_8));
}
.color_b_9 {
	color: hsl(var(--color_b_9));
}
.color_c_1 {
	color: hsl(var(--color_c_1));
}
.color_c_2 {
	color: hsl(var(--color_c_2));
}
.color_c_3 {
	color: hsl(var(--color_c_3));
}
.color_c_4 {
	color: hsl(var(--color_c_4));
}
.color_c_5 {
	color: hsl(var(--color_c_5));
}
.color_c_6 {
	color: hsl(var(--color_c_6));
}
.color_c_7 {
	color: hsl(var(--color_c_7));
}
.color_c_8 {
	color: hsl(var(--color_c_8));
}
.color_c_9 {
	color: hsl(var(--color_c_9));
}
.color_d_1 {
	color: hsl(var(--color_d_1));
}
.color_d_2 {
	color: hsl(var(--color_d_2));
}
.color_d_3 {
	color: hsl(var(--color_d_3));
}
.color_d_4 {
	color: hsl(var(--color_d_4));
}
.color_d_5 {
	color: hsl(var(--color_d_5));
}
.color_d_6 {
	color: hsl(var(--color_d_6));
}
.color_d_7 {
	color: hsl(var(--color_d_7));
}
.color_d_8 {
	color: hsl(var(--color_d_8));
}
.color_d_9 {
	color: hsl(var(--color_d_9));
}
.color_e_1 {
	color: hsl(var(--color_e_1));
}
.color_e_2 {
	color: hsl(var(--color_e_2));
}
.color_e_3 {
	color: hsl(var(--color_e_3));
}
.color_e_4 {
	color: hsl(var(--color_e_4));
}
.color_e_5 {
	color: hsl(var(--color_e_5));
}
.color_e_6 {
	color: hsl(var(--color_e_6));
}
.color_e_7 {
	color: hsl(var(--color_e_7));
}
.color_e_8 {
	color: hsl(var(--color_e_8));
}
.color_e_9 {
	color: hsl(var(--color_e_9));
}
.color_f_1 {
	color: hsl(var(--color_f_1));
}
.color_f_2 {
	color: hsl(var(--color_f_2));
}
.color_f_3 {
	color: hsl(var(--color_f_3));
}
.color_f_4 {
	color: hsl(var(--color_f_4));
}
.color_f_5 {
	color: hsl(var(--color_f_5));
}
.color_f_6 {
	color: hsl(var(--color_f_6));
}
.color_f_7 {
	color: hsl(var(--color_f_7));
}
.color_f_8 {
	color: hsl(var(--color_f_8));
}
.color_f_9 {
	color: hsl(var(--color_f_9));
}
.color_g_1 {
	color: hsl(var(--color_g_1));
}
.color_g_2 {
	color: hsl(var(--color_g_2));
}
.color_g_3 {
	color: hsl(var(--color_g_3));
}
.color_g_4 {
	color: hsl(var(--color_g_4));
}
.color_g_5 {
	color: hsl(var(--color_g_5));
}
.color_g_6 {
	color: hsl(var(--color_g_6));
}
.color_g_7 {
	color: hsl(var(--color_g_7));
}
.color_g_8 {
	color: hsl(var(--color_g_8));
}
.color_g_9 {
	color: hsl(var(--color_g_9));
}
.color_h_1 {
	color: hsl(var(--color_h_1));
}
.color_h_2 {
	color: hsl(var(--color_h_2));
}
.color_h_3 {
	color: hsl(var(--color_h_3));
}
.color_h_4 {
	color: hsl(var(--color_h_4));
}
.color_h_5 {
	color: hsl(var(--color_h_5));
}
.color_h_6 {
	color: hsl(var(--color_h_6));
}
.color_h_7 {
	color: hsl(var(--color_h_7));
}
.color_h_8 {
	color: hsl(var(--color_h_8));
}
.color_h_9 {
	color: hsl(var(--color_h_9));
}
.color_i_1 {
	color: hsl(var(--color_i_1));
}
.color_i_2 {
	color: hsl(var(--color_i_2));
}
.color_i_3 {
	color: hsl(var(--color_i_3));
}
.color_i_4 {
	color: hsl(var(--color_i_4));
}
.color_i_5 {
	color: hsl(var(--color_i_5));
}
.color_i_6 {
	color: hsl(var(--color_i_6));
}
.color_i_7 {
	color: hsl(var(--color_i_7));
}
.color_i_8 {
	color: hsl(var(--color_i_8));
}
.color_i_9 {
	color: hsl(var(--color_i_9));
}

.bg_a_1 {
	background-color: hsl(var(--color_a_1));
}
.bg_a_2 {
	background-color: hsl(var(--color_a_2));
}
.bg_a_3 {
	background-color: hsl(var(--color_a_3));
}
.bg_a_4 {
	background-color: hsl(var(--color_a_4));
}
.bg_a_5 {
	background-color: hsl(var(--color_a_5));
}
.bg_a_6 {
	background-color: hsl(var(--color_a_6));
}
.bg_a_7 {
	background-color: hsl(var(--color_a_7));
}
.bg_a_8 {
	background-color: hsl(var(--color_a_8));
}
.bg_a_9 {
	background-color: hsl(var(--color_a_9));
}
.bg_b_1 {
	background-color: hsl(var(--color_b_1));
}
.bg_b_2 {
	background-color: hsl(var(--color_b_2));
}
.bg_b_3 {
	background-color: hsl(var(--color_b_3));
}
.bg_b_4 {
	background-color: hsl(var(--color_b_4));
}
.bg_b_5 {
	background-color: hsl(var(--color_b_5));
}
.bg_b_6 {
	background-color: hsl(var(--color_b_6));
}
.bg_b_7 {
	background-color: hsl(var(--color_b_7));
}
.bg_b_8 {
	background-color: hsl(var(--color_b_8));
}
.bg_b_9 {
	background-color: hsl(var(--color_b_9));
}
.bg_c_1 {
	background-color: hsl(var(--color_c_1));
}
.bg_c_2 {
	background-color: hsl(var(--color_c_2));
}
.bg_c_3 {
	background-color: hsl(var(--color_c_3));
}
.bg_c_4 {
	background-color: hsl(var(--color_c_4));
}
.bg_c_5 {
	background-color: hsl(var(--color_c_5));
}
.bg_c_6 {
	background-color: hsl(var(--color_c_6));
}
.bg_c_7 {
	background-color: hsl(var(--color_c_7));
}
.bg_c_8 {
	background-color: hsl(var(--color_c_8));
}
.bg_c_9 {
	background-color: hsl(var(--color_c_9));
}
.bg_d_1 {
	background-color: hsl(var(--color_d_1));
}
.bg_d_2 {
	background-color: hsl(var(--color_d_2));
}
.bg_d_3 {
	background-color: hsl(var(--color_d_3));
}
.bg_d_4 {
	background-color: hsl(var(--color_d_4));
}
.bg_d_5 {
	background-color: hsl(var(--color_d_5));
}
.bg_d_6 {
	background-color: hsl(var(--color_d_6));
}
.bg_d_7 {
	background-color: hsl(var(--color_d_7));
}
.bg_d_8 {
	background-color: hsl(var(--color_d_8));
}
.bg_d_9 {
	background-color: hsl(var(--color_d_9));
}
.bg_e_1 {
	background-color: hsl(var(--color_e_1));
}
.bg_e_2 {
	background-color: hsl(var(--color_e_2));
}
.bg_e_3 {
	background-color: hsl(var(--color_e_3));
}
.bg_e_4 {
	background-color: hsl(var(--color_e_4));
}
.bg_e_5 {
	background-color: hsl(var(--color_e_5));
}
.bg_e_6 {
	background-color: hsl(var(--color_e_6));
}
.bg_e_7 {
	background-color: hsl(var(--color_e_7));
}
.bg_e_8 {
	background-color: hsl(var(--color_e_8));
}
.bg_e_9 {
	background-color: hsl(var(--color_e_9));
}
.bg_f_1 {
	background-color: hsl(var(--color_f_1));
}
.bg_f_2 {
	background-color: hsl(var(--color_f_2));
}
.bg_f_3 {
	background-color: hsl(var(--color_f_3));
}
.bg_f_4 {
	background-color: hsl(var(--color_f_4));
}
.bg_f_5 {
	background-color: hsl(var(--color_f_5));
}
.bg_f_6 {
	background-color: hsl(var(--color_f_6));
}
.bg_f_7 {
	background-color: hsl(var(--color_f_7));
}
.bg_f_8 {
	background-color: hsl(var(--color_f_8));
}
.bg_f_9 {
	background-color: hsl(var(--color_f_9));
}
.bg_g_1 {
	background-color: hsl(var(--color_g_1));
}
.bg_g_2 {
	background-color: hsl(var(--color_g_2));
}
.bg_g_3 {
	background-color: hsl(var(--color_g_3));
}
.bg_g_4 {
	background-color: hsl(var(--color_g_4));
}
.bg_g_5 {
	background-color: hsl(var(--color_g_5));
}
.bg_g_6 {
	background-color: hsl(var(--color_g_6));
}
.bg_g_7 {
	background-color: hsl(var(--color_g_7));
}
.bg_g_8 {
	background-color: hsl(var(--color_g_8));
}
.bg_g_9 {
	background-color: hsl(var(--color_g_9));
}
.bg_h_1 {
	background-color: hsl(var(--color_h_1));
}
.bg_h_2 {
	background-color: hsl(var(--color_h_2));
}
.bg_h_3 {
	background-color: hsl(var(--color_h_3));
}
.bg_h_4 {
	background-color: hsl(var(--color_h_4));
}
.bg_h_5 {
	background-color: hsl(var(--color_h_5));
}
.bg_h_6 {
	background-color: hsl(var(--color_h_6));
}
.bg_h_7 {
	background-color: hsl(var(--color_h_7));
}
.bg_h_8 {
	background-color: hsl(var(--color_h_8));
}
.bg_h_9 {
	background-color: hsl(var(--color_h_9));
}
.bg_i_1 {
	background-color: hsl(var(--color_i_1));
}
.bg_i_2 {
	background-color: hsl(var(--color_i_2));
}
.bg_i_3 {
	background-color: hsl(var(--color_i_3));
}
.bg_i_4 {
	background-color: hsl(var(--color_i_4));
}
.bg_i_5 {
	background-color: hsl(var(--color_i_5));
}
.bg_i_6 {
	background-color: hsl(var(--color_i_6));
}
.bg_i_7 {
	background-color: hsl(var(--color_i_7));
}
.bg_i_8 {
	background-color: hsl(var(--color_i_8));
}
.bg_i_9 {
	background-color: hsl(var(--color_i_9));
}
...
.shadow_h_xs {
	box-shadow: var(--shadow_h_xs);
}
.shadow_h_sm {
	box-shadow: var(--shadow_h_sm);
}
.shadow_h_md {
	box-shadow: var(--shadow_h_md);
}
.shadow_h_lg {
	box-shadow: var(--shadow_h_lg);
}
.shadow_h_xl {
	box-shadow: var(--shadow_h_xl);
}
.shadow_h_outset_xs {
	box-shadow: var(--shadow_h_outset_xs);
}
.shadow_h_outset_sm {
	box-shadow: var(--shadow_h_outset_sm);
}
.shadow_h_outset_md {
	box-shadow: var(--shadow_h_outset_md);
}
.shadow_h_outset_lg {
	box-shadow: var(--shadow_h_outset_lg);
}
.shadow_h_outset_xl {
	box-shadow: var(--shadow_h_outset_xl);
}
.shadow_h_inset_xs {
	box-shadow: var(--shadow_h_inset_xs);
}
.shadow_h_inset_sm {
	box-shadow: var(--shadow_h_inset_sm);
}
.shadow_h_inset_md {
	box-shadow: var(--shadow_h_inset_md);
}
.shadow_h_inset_lg {
	box-shadow: var(--shadow_h_inset_lg);
}
.shadow_h_inset_xl {
	box-shadow: var(--shadow_h_inset_xl);
}
.shadow_i_xs {
	box-shadow: var(--shadow_i_xs);
}
.shadow_i_sm {
	box-shadow: var(--shadow_i_sm);
}
.shadow_i_md {
	box-shadow: var(--shadow_i_md);
}
.shadow_i_lg {
	box-shadow: var(--shadow_i_lg);
}
.shadow_i_xl {
	box-shadow: var(--shadow_i_xl);
}
.shadow_i_outset_xs {
	box-shadow: var(--shadow_i_outset_xs);
}
.shadow_i_outset_sm {
	box-shadow: var(--shadow_i_outset_sm);
}
.shadow_i_outset_md {
	box-shadow: var(--shadow_i_outset_md);
}
.shadow_i_outset_lg {
	box-shadow: var(--shadow_i_outset_lg);
}
.shadow_i_outset_xl {
	box-shadow: var(--shadow_i_outset_xl);
}
.shadow_i_inset_xs {
	box-shadow: var(--shadow_i_inset_xs);
}
.shadow_i_inset_sm {
	box-shadow: var(--shadow_i_inset_sm);
}
.shadow_i_inset_md {
	box-shadow: var(--shadow_i_inset_md);
}
.shadow_i_inset_lg {
	box-shadow: var(--shadow_i_inset_lg);
}
.shadow_i_inset_xl {
	box-shadow: var(--shadow_i_inset_xl);
}
...
.selectable:active {
	...
	border-color: hsl(var(--color_a_5));
}
.selectable.selected {
	cursor: default;
}
...
`;var tn=e("Both the docs and implementation of these need more work.",1),rn=e('<li class="svelte-1gekuvc"> </li>'),sn=e('<li class="svelte-1gekuvc"> </li>'),ln=e('<span class="font_mono">@ryanatkn/moss/style_utilities.css</span>'),en=e('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_utilities.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),dn=e('<span class="font_mono">@ryanatkn/moss/style_components.css</span>'),cn=e('<p class="source_link svelte-1gekuvc"><a href="https://github.com/ryanatkn/fuz/blob/main/src/lib/style_components.css" class="svelte-1gekuvc"><!> <span class="ml_xs">source</span></a></p> <!>',1),gn=e(`<!> <section><!> <p>Moss has three optional CSS files with different kinds of classes:</p> <!> <p>Utility classes use plain CSS for convenient HTML authoring. Many are based on Moss style <!>.</p> <p>Component classes are semantic groupings of styles.</p> <aside>Unused clases can be removed with build tooling, which is out of scope for Moss, and with a
			more sophisticated architecture these classes could potentially be generated on demand instead
			of distributed as static files.</aside></section> <section><!> <ul class="classes unstyled svelte-1gekuvc"></ul></section> <section><!> <aside>These are like utility classes but don't map as cleanly to a single style property.</aside> <ul class="classes unstyled svelte-1gekuvc"></ul></section> <section><!> <!> <!></section>`,1);function $n(B,E){V(E,!0);const Y=nn("classes"),N=["relative|absolute|fixed|sticky|static","overflow_auto|hidden|scroll|clip|visible","overflow_x|y_auto|hidden|scroll|clip|visible","inline|inline_block|block|flex|grid","display_none|contents","flex_1","float_none|left|right|inline_start|inline_end","flip_x|y|xy","font_sans|mono","line_height_xs-xl","size_xs-xl9","icon_size_xs-xl3","text_align_start|end|left|right|center|justify|justify_all|match_parent","vertical_align_baseline|sub|super|text_top|text_bottom|middle|top|bottom","font_weight_100-900","ellipsis","pixelated","text_1-3","darken|lighten_1-9","bg|fg","bg|fg_1-9","color_darken|lighten_1-9","color_bg|fg","color_bg|fg_1-9","hue_a-i","color_a-i_1 -9","bg_a-i_1-9","border_color_1-5","border_width_1-6","outline_width_1-3","border_none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset","radius_0|50|100","radius_xs3-xl","fade_0|100","fade_1-6","shadow_xs-xl","shadow_inset|outset_xs-xl","shadow_a-i_xs-xl","shadow_a-i_inset|outset_xs-xl","shadow_inherit|initial|none","w|h_0|100","w|h_xs-xl15","p|pt|pr|pb|pl|px|py_0","p|pt|pr|pb|pl|px|py_xs5-xl15","m|mx|my_auto","m|mt|mr|mb|ml|mx|my_0","m|mt|mr|mb|ml|mx|my_xs5-xl15","gap_xs5-xl15","column|row_gap_xs5-xl15"],W=["box","row","wrap|nowrap","formatted","width_xs-md","selectable","clickable","pane","panel","icon_button","plain","menu_item","chevron","chip"];Q(B,{tome:Y,children:(X,xn)=>{var u=gn(),f=b(u);an(f,{children:(d,_)=>{C();var s=tn();l(d,s)},$$slots:{default:!0}});var p=n(n(f,!0)),k=r(p);g(k,{text:"Optional CSS classes",slug:"css-classes"});var q=n(n(k,!0)),y=n(n(q,!0));w(y,{content:`<!-- +layout.svelte -->
<script>
	...
	// ...
<\/script>`});var x=n(n(y,!0)),G=n(r(x));Z(G,{name:"variables"}),C(),o(x);var J=n(n(x,!0));n(n(J,!0)),o(p);var h=n(n(p,!0)),z=r(h);g(z,{text:"Utility classes",slug:"utility-classes"});var O=n(n(z,!0));U(O,73,()=>N,L,(d,_,s)=>{var a=rn(),t=r(a);o(a),j(()=>I(t,`.${A(_)??""}`)),l(d,a)}),o(O),o(h);var v=n(n(h,!0)),T=r(v);g(T,{text:"Component classes",slug:"semantic-classes"});var F=n(n(T,!0)),$=n(n(F,!0));U($,73,()=>W,L,(d,_,s)=>{var a=sn(),t=r(a);o(a),j(()=>I(t,`.${A(_)??""}`)),l(d,a)}),o($),o(v);var D=n(n(v,!0)),S=r(D);g(S,{text:"Raw CSS",slug:"raw-css"});var M=n(n(S,!0));R(M,{summary:_=>{var s=ln();l(_,s)},children:(_,s)=>{var a=en(),t=b(a),c=r(t),i=r(c);P(i,{size:"var(--icon_size_xs)"}),n(n(i,!0)),o(c),o(t);var m=n(n(t,!0));w(m,{content:on,lang:"css"}),l(_,a)},$$slots:{default:!0}});var H=n(n(M,!0));R(H,{summary:_=>{var s=dn();l(_,s)},children:(_,s)=>{var a=cn(),t=b(a),c=r(t),i=r(c);P(i,{size:"var(--icon_size_xs)"}),n(n(i,!0)),o(c),o(t);var m=n(n(t,!0));w(m,{content:_n,lang:"css"}),l(_,a)},$$slots:{default:!0}}),o(D),l(X,u)},$$slots:{default:!0}}),K()}export{$n as component};
