...
<script>
	...
	// ...
<\/script>`});var p=n(n(y,!0)),G=n(t(p));Z(G,{name:"variables"}),M(),a(p);var J=n(n(p,!0));n(n(J,!0)),a(x);var v=n(n(x,!0)),z=t(v);g(z,{text:"Utility classes",slug:"utility-classes"});var O=n(n(z,!0));I(O,73,()=>Y,L,(d,_,s)=>{var o=tn(),r=t(o);a(o),j(()=>U(r,`.${A(_)??""}`)),l(d,o)}),a(O),a(v);var h=n(n(v,!0)),T=t(h);g(T,{text:"Component classes",slug:"semantic-classes"});var F=n(n(T,!0)),D=n(n(F,!0));I(D,73,()=>N,L,(d,_,s)=>{var o=sn(),r=t(o);a(o),j(()=>U(r,`.${A(_)??""}`)),l(d,o)}),a(D),a(h);var $=n(n(h,!0)),S=t($);g(S,{text:"Raw CSS",slug:"raw-css"});var C=n(n(S,!0));R(C,{summary:_=>{var s=ln();l(_,s)},children:(_,s)=>{var o=en(),r=w(o),c=t(r),i=t(c);P(i,{size:"var(--icon_size_xs)"}),n(n(i,!0)),a(c),a(r);var m=n(n(r,!0));b(m,{content:an,lang:"css"}),l(_,o)},$$slots:{default:!0}});var H=n(n(C,!0));R(H,{summary:_=>{var s=dn();l(_,s)},children:(_,s)=>{var o=cn(),r=w(o),c=t(r),i=t(c);P(i,{size:"var(--icon_size_xs)"}),n(n(i,!0)),a(c),a(r);var m=n(n(r,!0));b(m,{content:_n,lang:"css"}),l(_,o)},$$slots:{default:!0}}),a($),l(X,u)},$$slots:{default:!0}}),K()}export{Dn as component};
