import{b as J,a as s,t as d}from"../chunks/disclose-version.BUQKzkHR.js";import{p as F,a as H,f as m,T as i,s as o,c as r,r as a,t as M,P as I}from"../chunks/runtime.B3w0Sz81.js";import{s as A}from"../chunks/render.CMkdwi7K.js";import{e as U,i as P}from"../chunks/class.OuJpC35m.js";import{C as b}from"../chunks/Code.B5NC9bOb.js";import{T as V}from"../chunks/Tome_Detail.BAb9hl_9.js";import{T as K}from"../chunks/Tome_Link.CfAz92YS.js";import{G as L}from"../chunks/Github_Logo.Csp5p1_1.js";import{a as Q}from"../chunks/tome.D6vM4_17.js";import{D as R}from"../chunks/Details.Dn2JYvJs.js";import{T as h}from"../chunks/Tome_Subheading.Blzx3qpA.js";import{U as Z}from"../chunks/Unfinished_Implementation_Warning.DkBbiAG1.js";const nn=`/* @ryanatkn/moss/style_utilities.css */
...
<script>
	...
	// ...
<\/script>`});var z=o(k,2),q=o(r(z));K(q,{name:"variables"}),i(),a(z),i(4),a(x);var v=o(x,2),O=r(v);h(O,{text:"Utility classes",slug:"utility-classes"});var j=o(O,2);U(j,21,()=>Y,P,(l,_)=>{var n=an(),t=r(n);a(n),M(()=>A(t,`.${I(_)??""}`)),s(l,n)}),a(j),a(v);var g=o(v,2),T=r(g);h(T,{text:"Component classes",slug:"semantic-classes"});var D=o(T,4);U(D,21,()=>N,P,(l,_)=>{var n=_n(),t=r(n);a(n),M(()=>A(t,`.${I(_)??""}`)),s(l,n)}),a(D),a(g);var S=o(g,2),$=r(S);h($,{text:"Raw CSS",slug:"raw-css"});var C=o($,2);R(C,{summary:_=>{var n=rn();s(_,n)},children:(_,n)=>{var t=tn(),e=m(t),c=r(e),p=r(c);L(p,{size:"var(--icon_size_xs)"}),i(2),a(c),a(e);var w=o(e,2);b(w,{content:nn,lang:"css"}),s(_,t)},$$slots:{default:!0}});var G=o(C,2);R(G,{summary:_=>{var n=sn();s(_,n)},children:(_,n)=>{var t=ln(),e=m(t),c=r(e),p=r(c);L(p,{size:"var(--icon_size_xs)"}),i(2),a(c),a(e);var w=o(e,2);b(w,{content:on,lang:"css"}),s(_,t)},$$slots:{default:!0}}),a(S),s(X,u)},$$slots:{default:!0}}),H()}export{zn as component};
