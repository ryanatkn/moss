<script lang="ts">
	...
	const style_utilities_items = [
		...
		'fade_1-6',
		'shadow_xs-xl',
		'shadow_inset|outset|inner|outer_xs-xl',
		'highlight_xs-xl',
		'highlight_inset|outset|inner|outer_xs-xl',
		'glow_xs-xl',
		'glow_inset|outset|inner|outer_xs-xl',
		'shroud_xs-xl',
		'shroud_inset|outset|inner|outer_xs-xl',
		'shadow_a-i_xs-xl',
		'shadow_a-i_inset|outset|inner|outer_xs-xl',
		'shadow_inherit|none',
		'w|h_0|100',
		'w|h_xs-xl15',
