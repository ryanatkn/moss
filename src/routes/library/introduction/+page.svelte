...
<Tome_Content {tome}>
	<section>
		...
		<ul>
			...
			<li>
				<Module_Link path="moss.css"><code>$routes/moss.css</code></Module_Link> - generated by
				<code>gro_plugin_moss_css</code>, includes the utility classes used by the local project
			</li>
			<li>
