	...
	<section>
		...
		<ul>
			...
			<li>
				...
				<a href="https://github.com/ryanatkn/gro">Gro</a> with Moss's gen helpers
				<Module_Link path="gen_moss_css.js" />
				(see the implementation if you're interested in using it outside of Gro, it's not that complex)
			</li>
			<li>
