	...
	modules: {
		...
		'./variables.js': {
			...
			declarations: [
				...
				{name: 'glow_alpha_xs', kind: 'variable'},
				{name: 'glow_alpha_sm', kind: 'variable'},
				{name: 'glow_alpha_md', kind: 'variable'},
				{name: 'glow_alpha_lg', kind: 'variable'},
				{name: 'glow_alpha_xl', kind: 'variable'},
