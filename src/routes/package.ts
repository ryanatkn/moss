			...
			identifiers: [
				{
					...
					kind: 'type',
					source_line: 3,
					type_signature: 'Class_Template_Result',
				},
				{
					name: 'Class_Template_Fn',
					kind: 'type',
					source_line: 8,
					type_signature: 'Class_Template_Fn<T1, T2, T3>',
					generic_params: [
						{
							name: 'T1',
							default_type: 'string',
				...
				},
				{
					...
					source_line: 37,
					type_signature:
						'<T1 = string, T2 = string, T3 = string>(template: Class_Template_Fn<T1, T2, T3>, values: Iterable<T1>, secondary?: Iterable<T2> | undefined, tertiary?: Iterable<...> | undefined): Record<...>',
					return_type: 'Record<string, Css_Class_Declaration>',
					parameters: [
						{
							name: 'template',
							type: 'Class_Template_Fn<T1, T2, T3>',
							optional: false,
				...
				},
				{
					...
					kind: 'function',
					source_line: 91,
					type_signature: '(property: string): Record<string, Css_Class_Declaration>',
					return_type: 'Record<string, Css_Class_Declaration>',
					parameters: [
						{
							name: 'property',
				...
				},
				{
					...
					source_line: 144,
					type_signature:
						'(property: string, values: Iterable<string>, formatter?: ((value: string) => string) | undefined, prefix?: string): Record<string, Css_Class_Declaration>',
					return_type: 'Record<string, Css_Class_Declaration>',
					parameters: [
						{
							name: 'property',
				...
				},
				{
					...
					source_line: 167,
					type_signature:
						'(property: string, values: Iterable<string>, formatter?: ((v: string) => string) | undefined): Record<string, Css_Class_Declaration>',
					return_type: 'Record<string, Css_Class_Declaration>',
					parameters: [
						{
							name: 'property',
				...
				},
				{
					...
					source_line: 211,
					type_signature:
						'(property: string, values: Iterable<string>): Record<string, Css_Class_Declaration>',
					return_type: 'Record<string, Css_Class_Declaration>',
					parameters: [
						{
							name: 'property',
				...
				},
				{
					...
					source_line: 236,
					type_signature:
						'(values: Iterable<string>, formatter?: ((value: string) => string) | undefined): Record<string, Css_Class_Declaration>',
					return_type: 'Record<string, Css_Class_Declaration>',
					parameters: [
						{
							name: 'values',
				...
				},
				{
					...
					source_line: 265,
					type_signature:
						'(sizes: Iterable<string>, alpha_mapping: Record<string, string>): Record<string, Css_Class_Declaration>',
					return_type: 'Record<string, Css_Class_Declaration>',
					parameters: [
						{
							name: 'sizes',
		...
		},
		{
			...
			identifiers: [
				...
				},
				{
					...
					source_line: 70,
					type_signature: '(contents: string, extractors?: Css_Extractor[]): Set<string>',
				...
				},
				{
					...
					kind: 'type',
					source_line: 142,
					type_signature: 'Css_Class_Declaration',
				},
				{
					name: 'Css_Class_Declaration_Base',
					kind: 'type',
					source_line: 147,
					type_signature: 'Css_Class_Declaration_Base',
					properties: [
						{
							name: 'comment',
							kind: 'variable',
				...
				},
				{
					...
					kind: 'type',
					source_line: 151,
					type_signature: 'Css_Class_Declaration_Item',
					extends: ['Css_Class_Declaration_Base'],
					properties: [
						{
							name: 'declaration',
							kind: 'variable',
				...
				},
				{
					...
					kind: 'type',
					source_line: 154,
					type_signature: 'Css_Class_Declaration_Group',
					extends: ['Css_Class_Declaration_Base'],
					properties: [
						{
							name: 'ruleset',
				...
				},
				{
					...
					source_line: 162,
					type_signature:
						'(classes: Iterable<string>, classes_by_name: Record<string, Css_Class_Declaration | undefined>, interpreters: Css_Class_Declaration_Interpreter[], log?: Logger | undefined): string',
					return_type: 'string',
					parameters: [
						{
							name: 'classes',
						...
						},
						{
							...
							type: 'Record<string, Css_Class_Declaration | undefined>',
							optional: false,
						},
						{
							name: 'interpreters',
			...
			identifiers: [
				{
					...
					kind: 'type',
					source_line: 14,
					type_signature: 'Gen_Moss_Css_Options',
					properties: [
						{
							name: 'filter_file',
							kind: 'variable',
							type_signature: 'File_Filter | null',
						},
						{
							name: 'include_stats',
							kind: 'variable',
						...
						},
						{
							...
							kind: 'variable',
							type_signature: 'Array<Css_Class_Declaration_Interpreter>',
						},
					],
				},
				{
					...
					kind: 'function',
					source_line: 29,
					type_signature: '(options?: Gen_Moss_Css_Options): Gen',
					return_type: 'Gen',
					parameters: [
						{
							name: 'options',
							type: 'Gen_Moss_Css_Options',
							optional: false,
							default_value: '{}',
						},
					],
		...
		},
		{
			...
			identifiers: [
				...
				},
				{
					...
					properties: [
						...
						},
						{
							name: 'variables',
							kind: 'variable',
							type_signature: 'Array<Style_Variable>',
						},
					],
				},
				{
					...
					kind: 'type',
					source_line: 17,
					type_signature: 'Render_Theme_Style_Options',
					properties: [
						{
							name: 'comments',
							kind: 'variable',
				...
				},
				{
					...
					kind: 'function',
					source_line: 28,
					type_signature: '(theme: Theme, options?: Render_Theme_Style_Options): string',
					return_type: 'string',
					parameters: [
						{
							name: 'theme',
						...
						{
							name: 'options',
							type: 'Render_Theme_Style_Options',
							optional: false,
							default_value: '{}',
						},
					],
				},
				{
					...
					kind: 'function',
					source_line: 62,
					type_signature: '(variable: Style_Variable, dark?: boolean, comments?: boolean): string',
					return_type: 'string',
					parameters: [
						{
							name: 'variable',
			...
			identifiers: [
				{
					...
					kind: 'type',
					source_line: 5,
					type_signature: 'Style_Variable_Name',
				},
				{
					name: 'Style_Variable',
					kind: 'type',
				...
				},
				{
					...
					kind: 'function',
					source_line: 16,
					type_signature: '(name: string): name is Style_Variable_Name',
					return_type: 'boolean',
					parameters: [
						{
							name: 'name',
