	...
	modules: {
		...
		'./variables.js': {
			...
			declarations: [
				...
				{name: 'depth_xs', kind: 'variable'},
				{name: 'depth_sm', kind: 'variable'},
				{name: 'depth_md', kind: 'variable'},
				{name: 'depth_lg', kind: 'variable'},
				{name: 'depth_xl', kind: 'variable'},
				{name: 'lift_xs', kind: 'variable'},
				{name: 'lift_sm', kind: 'variable'},
				{name: 'lift_md', kind: 'variable'},
				{name: 'lift_lg', kind: 'variable'},
				{name: 'lift_xl', kind: 'variable'},
