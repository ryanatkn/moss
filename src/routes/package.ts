	...
	modules: {
		...
		'./variable_data.js': {
			...
			declarations: [
				...
				{name: 'Shadow_Semantic_Value', kind: 'type'},
				{name: 'shadow_semantic_values', kind: 'variable'},
				{name: 'Icon_Size_Variant', kind: 'type'},
				{name: 'icon_size_variants', kind: 'variable'},
				{name: 'icon_sizes', kind: 'variable'},
				{name: 'Color_Variant', kind: 'type'},
				{name: 'color_variants', kind: 'variable'},
				{name: 'Border_Width_Variant', kind: 'type'},
				{name: 'border_width_variants', kind: 'variable'},
				{name: 'Outline_Width_Variant', kind: 'type'},
				{name: 'outline_width_variants', kind: 'variable'},
				...
				{name: 'Text_Align_Value', kind: 'type'},
				{name: 'text_align_values', kind: 'variable'},
				{name: 'Vertical_Align_Value', kind: 'type'},
				{name: 'vertical_align_values', kind: 'variable'},
				{name: 'Word_Break_Value', kind: 'type'},
				{name: 'word_break_values', kind: 'variable'},
				{name: 'Position_Value', kind: 'type'},
				{name: 'position_values', kind: 'variable'},
				{name: 'Visibility_Value', kind: 'type'},
				{name: 'visibility_values', kind: 'variable'},
				{name: 'Float_Value', kind: 'type'},
				{name: 'float_values', kind: 'variable'},
				{name: 'Flex_Wrap_Value', kind: 'type'},
				{name: 'flex_wrap_values', kind: 'variable'},
				{name: 'Flex_Direction_Value', kind: 'type'},
				{name: 'flex_direction_values', kind: 'variable'},
				{name: 'Overflow_Wrap_Value', kind: 'type'},
				{name: 'overflow_wrap_values', kind: 'variable'},
				{name: 'Scrollbar_Width_Value', kind: 'type'},
