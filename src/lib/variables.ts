...
export const hue_i: Style_Variable = {name: 'hue_i', light: '185', summary: 'cyan'};
export const hue_j: Style_Variable = {name: 'hue_j', light: '157', summary: 'teal'};
...
export const fill_j: Style_Variable = {
	name: 'fill_j',
	light: 'var(--color_j_4)',
	dark: 'var(--color_j_6)',
};
...
export const border_color_j: Style_Variable = {
	name: 'border_color_j',
	light: 'var(--color_j_5)',
};
...
export const shadow_color_j: Style_Variable = {
	name: 'shadow_color_j',
	light: 'var(--color_j_6)',
	dark: 'var(--color_j_4)',
};
