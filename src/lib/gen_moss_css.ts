...
import {css_classes_by_name, css_class_interpreters} from './css_classes.js';
...
export const gen_moss_css = (options: Gen_Moss_Css_Options = {}): Gen => {
	const {filter_file = filter_file_default, include_stats = false} = options;
	...
	return {
		...
		generate: async ({filer, log, origin_path}) => {
			...
			const css = generate_classes_css(
				css_classes.get(),
				css_classes_by_name,
